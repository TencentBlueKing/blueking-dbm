...
"""
from backend.flow.engine.bamboo.scene.name_service.es_name_service import EsNameServiceFlow
from backend.flow.engine.controller.base import BaseController


class EsNameServiceController(BaseController):
    """
    名字服务相关控制器
    """
    ...
    def clb_create(self):
        ...
        创建clb
        """
        flow = EsNameServiceFlow(root_id=self.root_id, data=self.ticket_data)
