...
class RedisClusterAutoFixSceneFlow(object):
    ...
    def start_redis_auotfix(self):
        ...
        for cluster_replacement in self.data["infos"]:
            ...
            sub_pipeline = self.cluster_fix(flow_data, cluster_kwargs, cluster_replacement)
    ...
    # 组装&控制 集群替换流程
    def cluster_fix(self, flow_data, act_kwargs, replacement_param):
    ...
    def proxy_fix(self, sub_pipeline, act_kwargs, proxy_replace_info):
