...
class RedisDataStructureTaskDeleteFlow(object):
    ...
    def redis_data_structure_task_delete_flow(self):
        """
        ...
        for info in self.data["infos"]:
            ...
            logger.info("redis_data_structure_task_delete_flow tasks_info:{}".format(tasks_info))
            ...
            act_kwargs.cluster = {
                ...
                "meta_func_name": RedisDBMeta.update_roolback_task_status.__name__,
