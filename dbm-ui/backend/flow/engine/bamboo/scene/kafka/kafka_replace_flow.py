...
class KafkaReplaceFlow(object):
    ...
    def replace_kafka_flow(self):
        ...
        if self.data["new_nodes"].get("broker"):
            ...
            kafka_pipeline.add_sub_pipeline(sub_flow=sub_pipeline.build_sub_process(sub_name="扩容DBMeta"))
        ...
        kafka_pipeline.add_sub_pipeline(sub_flow=sub_pipeline.build_sub_process(sub_name="缩容DBMeta"))
