...
from backend.flow.plugins.components.collections.k8s_vm.k8s_vm_disable import K8sVmDisableComponent
...
class K8sVmDisableFlow(K8sVmBaseFlow):
    """
    构建k8s vm禁用流程
    """
    ...
    def deploy_vm_flow(self):
        ...
        # 调用dbs禁用接口
        vm_pipeline.add_act(
            act_name=_("禁用VictoriaMetrics集群"),
            act_component_code=K8sVmDisableComponent.code,
