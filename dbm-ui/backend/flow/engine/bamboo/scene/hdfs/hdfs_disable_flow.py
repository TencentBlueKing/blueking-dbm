...
class HdfsDisableFlow(object):
    ...
    def disable_hdfs_flow(self):
        ...
        for ip in all_ips:
            # 停止进程
            act_kwargs.get_hdfs_payload_func = HdfsActPayload.get_stop_process_payload.__name__
            act_kwargs.exec_ip = ip
            act = {
                "act_name": _("停止HDFS集群进程-{}").format(ip),
