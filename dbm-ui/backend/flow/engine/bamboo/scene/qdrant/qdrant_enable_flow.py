...
from backend.flow.plugins.components.collections.qdrant.k8s_qdrant_enable import K8sQdrantEnableComponent
...
class K8sQdrantEnableFlow(K8sQdrantBaseFlow):
    ...
    def deploy_qdrant_flow(self):
        ...
        qdrant_pipeline.add_act(
            act_name=_("启用Qdrant集群"), act_component_code=K8sQdrantEnableComponent.code, kwargs=asdict(act_kwargs)
        )
