...
from backend.flow.views.oracle_master_failover import OracleMasterFailoverApiView
...
from backend.flow.views.redis_cluster import (
    ...
    RedisRollbackDestroySceneApiView,
    RedisRollbackSceneApiView,
...
urlpatterns = [
    ...
    url(r"^scene/redis_rollback$", RedisRollbackSceneApiView.as_view()),
    url(r"^scene/redis_rollback_destroy$", RedisRollbackDestroySceneApiView.as_view()),
    ...
    url(r"^scene/multi_cluster_reduce_shard$", MongoDBClusterReduceShardView.as_view()),
    ...
    url(r"^scene/oracle_master_failover$", OracleMasterFailoverApiView.as_view()),
    # oracle end
    # mysql upgrade
