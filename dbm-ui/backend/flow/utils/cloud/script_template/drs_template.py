...
export SQLSERVER_ADMIN_PASSWORD="{{drs_password}}"
export SQLSERVER_ADMIN_USER="mssql_drs"
export DRS_PROXY_ADMIN_USER="proxy"
export DRS_PROXY_ADMIN_PASSWORD="{{proxy_password}}"
export DRS_WEBCONSOLE_USER="{{drs_webconsole_user}}"
...
export SQLSERVER_DATA_READ_PASSWORD="{{drs_password}}"
export SQLSERVER_SYS_READ_USER="mssql_sys_read_drs"
export SQLSERVER_SYS_READ_PASSWORD="{{drs_password}}"
