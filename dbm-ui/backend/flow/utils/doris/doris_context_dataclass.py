...
@dataclass()
class DorisActKwargs:
    """
    定义DORIS活动节点的私有变量dataclass类
    """
    ...
    get_doris_payload_func: str = None  # 上下文中DorisActPayload类的获取参数方法名称。空则传入None
    doris_role: str = None  # 表示单据执行的节点角色
...
@dataclass()
class DorisApplyContext:
    """
    定义申请DORIS集群的上下文dataclass类
    """
