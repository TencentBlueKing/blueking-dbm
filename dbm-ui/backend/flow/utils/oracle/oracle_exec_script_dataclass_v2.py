...
from backend.flow.consts import ExecuteShellScriptUser, OracleActuatorActionEnum
...
class ExecuteScriptActKwargs:
    ...
    def get_os_init_kwargs(self):
        ...
        return {
            ...
            "db_act_template": {
                "action": OracleActuatorActionEnum.OsInit,
    ...
    def get_execute_script_kwargs(self, info: dict) -> dict:
        ...
        return {
            ...
            "exec_ip": ip,
            "db_act_template": {
                "action": OracleActuatorActionEnum.OracleExecuteScript,
                "file_path": self.work_path,
                "payload": {
                    "app": self.app,
