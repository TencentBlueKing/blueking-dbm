...
@dataclass()
class OracleActKwargs:
    """
    定义Oracle活动节点的私有变量dataclass类
    """
    ...
    get_oracle_payload_func: str = None  # 上下文中OracleActPayload类的获取参数方法名称。空则传入None
...
class AddSlaveContext:
    ...
    path: dict = None  # 软链接配置信息
    orapw: dict = None  # 密码文件内容
    pfile: dict = None  # pfile文件内容
    master_configs: dict = None  # 旧主库配置信息

    @staticmethod
    def get_configs_var_name() -> str:
        return "configs"

    @staticmethod
    def get_path_var_name() -> str:
        return "path"

    @staticmethod
    def get_orapw_var_name() -> str:
        return "orapw"

    @staticmethod
    def get_pfile_var_name() -> str:
        return "pfile"

    @staticmethod
    def get_master_configs_var_name() -> str:
