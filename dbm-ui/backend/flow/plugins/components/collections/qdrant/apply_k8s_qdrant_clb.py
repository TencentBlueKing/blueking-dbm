...
class ApplyK8sQdrantClbService(BaseService):
    """
    申请k8s qdrant clb
    """
    ...
    def _execute(self, data, parent_data):
        ...
        params = {
            "region": region_code,
            "vpc_id": vpc_id,
            "clb_name": "{}-{}-qdrant-clb".format(cluster_name, bk_biz_id),
            "clb_nums": 1,
            "async_to_dbm": False,
        }
...
class ApplyK8sQdrantClbComponent(Component):
    name = __name__
    code = "apply_k8s_qdrant_clb"
    bound_service = ApplyK8sQdrantClbService
