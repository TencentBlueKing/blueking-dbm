...
class PulsarApplySummaryService(BaseService):
    """
    ...
    def _execute(self, data, parent_data) -> bool:
        ...
        for item in items:
            ...
            if cluster:
                summary_data["access_entry_url"] = "{}/{}/db-manage/pulsar/detail/{}?open=access_entry".format(
        ...
        FlowOutputHandler(PulsarApplySummarySerializer).insert_data(root_id, summary_data_list)
        return True
