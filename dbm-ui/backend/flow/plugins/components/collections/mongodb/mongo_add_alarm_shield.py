...
class MongoAddAlarmShieldService(BaseService):
    """
    ...
    def _execute(self, data, parent_data):
        ...
        if res.get("id") and isinstance(res["id"], int):
            return True
        return False
...
class MongoAddAlarmShieldComponent(Component):
    name = __name__
    code = "mongo_add_alarm_shield"
    bound_service = MongoAddAlarmShieldService
