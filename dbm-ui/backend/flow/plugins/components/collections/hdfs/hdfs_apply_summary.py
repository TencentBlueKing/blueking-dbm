...
class HdfsApplySummarySerializer(BaseFlowOutputSerializer):
    ...
    rpc_port = serializers.IntegerField(help_text=_("RPC端口"))
    access_entry_url = BaseFlowOutputSerializer.URLField(help_text=_("获取访问方式"), allow_blank=True, default="")


class HdfsApplySummaryService(BigDataApplySummaryService):
    """
    ...
    summary_serializer = HdfsApplySummarySerializer
    detail_path = "hdfs"
    port_field = "rpc_port"
