    ...
    def _create_machine(
        ...
        machine, _ = Machine.objects.get_or_create(
            ...
            defaults=dict(
                ...
                bk_os_name=cc_info.get("bk_os_name", ""),
                bk_idc_area=cc_info.get("bk_idc_area", ""),
                bk_idc_area_id=cc_info.get("bk_idc_area_id", 0),
                bk_sub_zone=cc_info.get("sub_zone", ""),
                bk_sub_zone_id=cc_info.get("sub_zone_id", "0"),
                bk_rack=cc_info.get("rack", ""),
                bk_rack_id=cc_info.get("rack_id", "0"),
                bk_svr_device_cls_name=cc_info.get("bk_svr_device_cls_name", ""),
                bk_idc_name=cc_info.get("idc_name", ""),
                bk_idc_id=cc_info.get("idc_id", 0),
                bk_cloud_id=0,
                net_device_id=cc_info.get("net_device_id", ""),
