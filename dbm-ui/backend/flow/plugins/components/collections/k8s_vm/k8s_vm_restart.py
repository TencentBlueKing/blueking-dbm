...
class K8sVmRestartService(BaseService):
    """
    重启 k8s vm 集群
    """
    ...
    def _execute(self, data, parent_data) -> bool:
        ...
        try:
            ...
            self.log_error(_("重启VictoriaMetrics集群[{}]失败: {}").format(cluster_detail["clusterName"], err))
            return False
        return True
...
class K8sVmRestartComponent(Component):
    name = __name__
    code = "k8s_vm_restart"
    bound_service = K8sVmRestartService
