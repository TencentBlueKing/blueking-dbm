...
class GetK8sVmClbDetailService(BaseService):
    """
    调用dbs接口查询CLB详情，使用pipeline schedule机制异步轮询
    """
...
class GetK8sVmClbDetailComponent(Component):
    name = __name__
    code = "get_k8s_vm_clb_detail"
    bound_service = GetK8sVmClbDetailService
