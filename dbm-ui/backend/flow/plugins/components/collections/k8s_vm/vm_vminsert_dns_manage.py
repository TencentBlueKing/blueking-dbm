...
class VmVminsertDnsManageService(BaseService):
    def _execute(self, data, parent_data) -> bool:
        ...
        result = dns_manage.create_domain(
            instance_list=[f"{vip}#{VMINSERT_PORT}"], add_domain_name=kwargs["domain_name"]
        )
...
class VmVminsertDnsManageComponent(Component):
    name = __name__
    code = "vm_vminsert_dns_manage"
    bound_service = VmVminsertDnsManageService
