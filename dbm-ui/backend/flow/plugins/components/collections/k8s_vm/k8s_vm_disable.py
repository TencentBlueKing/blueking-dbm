...
class K8sVmDisableService(BaseService):
    """
    禁用 k8s vm 集群
    """
    ...
    def _execute(self, data, parent_data) -> bool:
        ...
        try:
            ...
            self.log_error(_("禁用VictoriaMetrics集群[{}]失败: {}").format(cluster_detail["clusterName"], err))
            return False
        return True
...
class K8sVmDisableComponent(Component):
    name = __name__
    code = "k8s_vm_disable"
    bound_service = K8sVmDisableService
