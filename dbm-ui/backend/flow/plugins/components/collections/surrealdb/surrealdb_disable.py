...
class DisableSurrealDBService(BaseService):
    """
    调用dbs接口禁用 surrealdb 集群
    """
    ...
    def _execute(self, data, parent_data) -> bool:
        ...
        try:
            ...
            self.log_error(_("禁用 surrealdb 集群[{}]失败: {}").format(cluster_detail["clusterName"], e))
            return False
...
class DisableSurrealDBComponent(Component):
    name = __name__
    code = "disable_surrealdb"
    bound_service = DisableSurrealDBService
