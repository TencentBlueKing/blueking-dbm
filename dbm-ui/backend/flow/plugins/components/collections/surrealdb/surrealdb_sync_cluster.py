...
class SurrealDBSyncClusterService(BaseService):
    """
    同步 surrealdb 集群信息到 DBM
    """
...
class SurrealDBSyncClusterComponent(Component):
    name = __name__
    code = "surrealdb_sync_cluster"
    bound_service = SurrealDBSyncClusterService
