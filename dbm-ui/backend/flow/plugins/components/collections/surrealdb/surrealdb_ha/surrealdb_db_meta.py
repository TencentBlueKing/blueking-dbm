...
class SurrealdbDBMetaService(BaseService):
    """
    根据单据类型来更新cmdb
    """
    ...
    def _execute(self, data, parent_data):
        ...
        surrealdb_meta = SurrealdbDBMeta(ticket_data=global_data)
...
class SurrealdbDBMetaComponent(Component):
    name = __name__
    code = "surrealdb_db_meta"
    bound_service = SurrealdbDBMetaService
