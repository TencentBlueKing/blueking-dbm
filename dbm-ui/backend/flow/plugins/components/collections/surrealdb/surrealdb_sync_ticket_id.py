...
class SurrealDBSyncTicketIdService(BaseService):
    ...
    def _execute(self, data, parent_data):
        ...
        if global_data["ticket_type"] == TicketType.K8S_SURREALDB_DELETE:
    ...
    def get_request_type(ticket_type: str) -> str:
        if ticket_type == TicketType.K8S_SURREALDB_SINGLE_APPLY:
            return "CreateCluster"
        elif ticket_type == TicketType.K8S_SURREALDB_ENABLE:
            return "StartCluster"
        elif ticket_type == TicketType.K8S_SURREALDB_DISABLE:
            return "StopCluster"
        elif ticket_type == TicketType.K8S_SURREALDB_DELETE:
            return "DeleteCluster"
        elif ticket_type == TicketType.K8S_SURREALDB_RESTART:
...
class SurrealDBSyncTicketIdComponent(Component):
    name = __name__
    code = "surrealdb_sync_ticket_id"
    bound_service = SurrealDBSyncTicketIdService
