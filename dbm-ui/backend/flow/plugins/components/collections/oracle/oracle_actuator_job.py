...
from backend.flow.utils.oracle.oracle_script_template import (
...
class OracleExecuteDBActuatorJobService(BkJobService):
    """
    ...
    def _execute(self, data, parent_data) -> bool:
        ...
        exec_account = kwargs["exec_account"]
        template = jinja_env.from_string(oracle_actuator_template)
        if kwargs.get("os_init", False):
            template = jinja_env.from_string(oracle_os_init_actuator_template)
...
class OracleExecuteDBActuatorJobComponent(Component):
    name = __name__
    code = "oracle_db_actuator_execute"
    bound_service = OracleExecuteDBActuatorJobService
