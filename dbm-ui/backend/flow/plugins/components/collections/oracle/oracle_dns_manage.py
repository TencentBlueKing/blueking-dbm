...
class OracleDnsManageService(BaseService):
    """
    定义oracle集群域名管理的活动节点,目前只支持添加域名、删除域名
...
class OracleDnsManageComponent(Component):
    name = __name__
    code = "oracle_dns_manage"
    bound_service = OracleDnsManageService
