...
class OracleExecSendMediaOperation(BkJobService):
    """
    执行下发介质包
    """
    ...
    def _execute(self, data, parent_data) -> bool:
        ...
        payload["account_alias"] = kwargs["exec_account"]
...
class OracleExecSendMediaOperationComponent(Component):
    """
    OracleExecSendMediaOperation组件
    """

    name = __name__
    code = "oracle_send_media"
    bound_service = OracleExecSendMediaOperation
