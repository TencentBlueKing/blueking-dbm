...
class NameSpaceEnum(StrStructuredEnum):
    ...
    TwemproxyTendisSSDInstance = EnumField("TwemproxyTendisSSDInstance", _("twemproxy + TendisSSD架构"))
    PredixyRedisCluster = EnumField("PredixyRedisCluster", _("predixy + redis架构"))
    PredixyTendisplusCluster = EnumField("PredixyTendisplusCluster", _("predixy + tendisplus架构"))
    PredixyTendisplusInstance = EnumField("PredixyTendisplusInstance", _("predixy + tendisplus主从架构"))
...
class ConfigFileEnum(StrStructuredEnum):
    ...
    KeyMod = EnumField("keymod", _("key模式配置(合并base/hotkey/bigkey)"))
...
class DBActuatorActionEnum(StrStructuredEnum):
    ...
    UpgradeCheck = EnumField("upgrade-check", _("MySQL升级检查"))
    UpgradePrepare = EnumField("upgrade-prepare", _("MySQL升级准备"))
    UpgradeExec = EnumField("upgrade-exec", _("MySQL升级执行"))
...
class OracleActuatorActionEnum(StrStructuredEnum):
    ...
    GetTnsnamesFile = EnumField("get-tnsnames-file", _("get-tnsnames-file"))
    ...
    Shutdown = EnumField("shutdown", _("shutdown"))
    ShutdownForce = EnumField("shutdown-force", _("shutdown-force"))
    CheckConnections = EnumField("check-connections", _("check-connections"))
