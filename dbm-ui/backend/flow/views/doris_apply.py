...
class InstallDorisSceneApiView(FlowTestView):
    """
    api: /apis/v1/flow/scene/install_doris
    params:
    {
    ...
    def post(self, request):
        ...
        DorisController(root_id=root_id, ticket_data=request.data).doris_apply_scene()
