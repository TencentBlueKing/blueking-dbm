...
class FakeInstallDorisSceneApiView(MigrateFlowView):
    """
    api: /apis/v1/flow/scene/fake_install_doris
    params:
    {
        "bk_biz_id": 2005000002,
        "remark": "测试创建doris集群",
        "ticket_type": "DORIS_APPLY",
    ...
    def post(self, request):
        logger.info(_("开始部署Doris场景"))

        root_id = generate_root_id()
        logger.info("define root_id: {}".format(root_id))
        DorisController(root_id=root_id, ticket_data=request.data).doris_fake_apply_scene()
