...
class ScaleUpDorisSceneApiView(FlowTestView):
    """
        api: /apis/v1/flow/scene/scale_up_doris
        params:
        {
    ...
    def post(self, request):
        logger.info(_("开始扩容Doris场景"))

        root_id = generate_root_id()
        logger.info("define root_id: {}".format(root_id))
        DorisController(root_id=root_id, ticket_data=request.data).doris_scale_up_scene()
