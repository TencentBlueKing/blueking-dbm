...
from backend.flow.engine.controller.surrealdb_single import SurrealDBSingleController
...
class InstallSurrealDBSingleSceneApiView(FlowTestView):
    """
    api: /apis/v1/flow/scene/install_surrealdb_single
    params:
    {
    ...
    def post(self, request):
        ...
        SurrealDBSingleController(root_id=root_id, ticket_data=request.data).surrealdb_apply_scene()
