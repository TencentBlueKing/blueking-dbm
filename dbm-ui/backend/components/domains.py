...
ITSM_V4_APIGW_DOMAIN = env.ITSM_V4_APIGW_DOMAIN or "https://bkapi.paas3-dev.bktencent.com/api/cw-aitsm/prod/api/v1/"
...
# IAM V4 只提供网关接口，没有esb兜底
BKIAMV4_APIGW_DOMAIN = env.BK_IAM_V4_APIGATEWAY
...
KUBERNETES_APIGW_DOMAIN = env.KUBERNETES_APIGW_DOMAIN or ESB_DOMAIN_TPL.format("kubernetes")
