...
MYSQL_SIMULATION_DOMAIN = env.MYSQL_SIMULATION_DOMAIN or APIGW_DOMAIN_PREFIX_FORMAT.format("db_simulation")
...
CELERY_SERVICE_APIGW_DOMAIN = env.CELERY_SERVICE_APIGW_DOMAIN or APIGW_DOMAIN_PREFIX_FORMAT.format("celery_service")
# gcs/scr平台，后续可能会下架掉这两个系统
GCS_APIGW_DOMAIN = env.GCS_APIGW_DOMAIN or APIGW_DOMAIN_PREFIX_FORMAT.format("gcs")
SCR_APIGW_DOMAIN = env.SCR_APIGW_DOMAIN or APIGW_DOMAIN_PREFIX_FORMAT.format("scr")
