...
class _NameServiceApi(object):
    ...
    def __init__(self):
        self.clb_create_lb_and_register_target = DataAPI(
            ...
            url="/clb_create_lb_and_register_target",
            module=self.MODULE,
        ...
        self.clb_deregister_part_target = DataAPI(
            method="POST",
            base=NAMESERVICE_APIGW_DOMAIN,
            url="/clb_deregister_part_target",
            module=self.MODULE,
        ...
        self.clb_get_target_private_ips = DataAPI(
            method="POST",
            base=NAMESERVICE_APIGW_DOMAIN,
            url="/clb_get_target_private_ips",
            module=self.MODULE,
        ...
        self.clb_check_clb_register_target_by_ip = DataAPI(
            method="POST",
            base=NAMESERVICE_APIGW_DOMAIN,
            url="/clb_check_clb_register_target_by_ip",
            module=self.MODULE,
        ...
        self.clb_deregister_target_and_del_lb = DataAPI(
            method="POST",
            base=NAMESERVICE_APIGW_DOMAIN,
            url="/clb_deregister_target_and_del_lb",
            module=self.MODULE,
        ...
        self.polaris_create_service_alias_and_bind_targets = DataAPI(
            method="POST",
            base=NAMESERVICE_APIGW_DOMAIN,
            url="/polaris_create_service_alias_and_bind_targets",
            module=self.MODULE,
        ...
        self.polaris_unbind_part_targets = DataAPI(
            method="POST",
            base=NAMESERVICE_APIGW_DOMAIN,
            url="/polaris_unbind_part_targets",
            module=self.MODULE,
        ...
        self.polaris_unbind_targets_and_delete_alias_service = DataAPI(
            method="POST",
            base=NAMESERVICE_APIGW_DOMAIN,
            url="/polaris_unbind_targets_and_delete_alias_service",
            module=self.MODULE,
