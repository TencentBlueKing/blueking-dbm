...
class DutyRuleResourceProvider(BaseResourceProvider, CommonProviderMixin):
    """
    轮值策略资源的反向拉取类
    """

    model: models.Model = DutyRule
    resource_meta: ResourceMeta = ResourceEnum.DUTY_RULE
    ...
    def list_instance_by_policy(self, filter, page, **options):
        key_mapping = {
            ...
            f"{self.resource_meta.id}._bk_iam_path_": "db_type",
        }
        values_hook = {"db_type": lambda value: value[1:-1].split(",")[1]}
