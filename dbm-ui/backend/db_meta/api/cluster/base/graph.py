...
class Node:
    ...
    @staticmethod
    def generate_instance_state(ins: Union[StorageInstance, ProxyInstance, ClusterEntry]) -> str:
    ...
    def __init__(
        ...
        self.instance_state = instance_state if instance_state is not None else Node.generate_instance_state(ins)
