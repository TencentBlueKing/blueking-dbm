...
from .create import create_predixy_tendisplus_ins


class TendisPredixyTendisplusInstanceHandler(ClusterHandler):

    # 「必须」 集群类型
    cluster_type = ClusterType.TendisPredixyTendisplusInstance
    ...
    def create(
        ...
        create_predixy_tendisplus_ins(
            ...
            ip_port_storages=ip_port_storages,
        )
    ...
    def add_predixies(self, proxies: List[Dict]):
        return add_proxies(self.cluster, proxies)

    def delete_predixies(self, proxies: List[Dict]):
