...
from backend.db_meta.api.cluster.nosqlcomm.scale_tendis import make_sync_msms, redo_slaves, switch_tendis
from backend.db_meta.enums import ClusterType


class TendisCacheClusterHandler(ClusterHandler):
    @classmethod
    @transaction.atomic
    def create(
        cls,
    ...
    def make_sync(self, tendiss):
        return make_sync_msms(self.cluster, tendiss)
