...
WEBCONSOLERS_USERNAME = get_type_env(key="WEBCONSOLE_USERNAME", _type=str, default="")
WEBCONSOLERS_PASSWORD = get_type_env(key="WEBCONSOLE_PASSWORD", _type=str, default="")
