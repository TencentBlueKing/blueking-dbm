...
# 测试/联调环境跳过安装 bkmonitorbeat、bkunifylogbeat（节点管理常失败）；正式环境保持 False
MONGODB_SKIP_INSTALL_PLUGIN = get_type_env(key="MONGODB_SKIP_INSTALL_PLUGIN", _type=bool, default=False)
