...
BKLOG_REDIS_BINLOG_BACKUP_RESULT_RETENTION = get_type_env(key="BKLOG_REDIS_BINLOG_BACKUP_RESULT_RETENTION", _type=int)
BKLOG_REDIS_FULLBACKUP_RESULT_RETENTION = get_type_env(key="BKLOG_REDIS_FULLBACKUP_RESULT_RETENTION", _type=int)
BKLOG_REDIS_BIGKEY_RETENTION = get_type_env(key="BKLOG_REDIS_BIGKEY_RETENTION", _type=int)
BKLOG_REDIS_SLOWLOG_RETENTION = get_type_env(key="BKLOG_REDIS_SLOWLOG_RETENTION", _type=int)
BKLOG_MONGO_BACKUP_RESULT_RETENTION = get_type_env(key="BKLOG_MONGO_BACKUP_RESULT_RETENTION", _type=int)
