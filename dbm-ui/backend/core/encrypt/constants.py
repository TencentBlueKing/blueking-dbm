...
class CipherPadding(StrStructuredEnum):
    """填充标志"""
...
class KeyObjType(StrStructuredEnum):
    """密钥对象类型"""
...
class AsymmetricCipherKeyType(StrStructuredEnum):
    """密钥类型"""
...
class AsymmetricCipherConfigType(StrStructuredEnum):
    """
    系统配置的非对称加密类型
...
class AsymmetricCipherType(StrStructuredEnum):
    """非对称加密算法类型"""
...
class SymmetricCipherType(StrStructuredEnum):
    """对称加密算法类型"""
