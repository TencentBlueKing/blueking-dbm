...
class TicketType(str, StructuredEnum):
    ...
    TENDBCLUSTER_SPIDER_MNT_DESTROY = EnumField("TENDBCLUSTER_SPIDER_MNT_DESTROY", _("TenDB Cluster 添加临时节点"))
    TENDBCLUSTER_SPIDER_SLAVE_APPLY = EnumField("TENDBCLUSTER_SPIDER_SLAVE_APPLY", _("TenDB Cluster 部署只读集群"))
    TENDBCLUSTER_SPIDER_SLAVE_DESTROY = EnumField("TENDBCLUSTER_SPIDER_SLAVE_DESTROY", _("TenDB Cluster 只读集群下架"))
