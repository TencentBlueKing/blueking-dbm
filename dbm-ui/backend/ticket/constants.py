...
class TicketType(StrStructuredEnum):
    ...
    MONGODB_INSTANCE_FIX_STATUS = TicketEnumField("MONGODB_INSTANCE_FIX_STATUS", _("Mongos 状态修复"), _("集群维护"))
    MONGODB_CLUSTER_STANDARDIZE = TicketEnumField("MONGODB_CLUSTER_STANDARDIZE", _("MongoDB 集群标准化"))  # noqa
