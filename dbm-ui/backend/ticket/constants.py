...
class TicketType(str, StructuredEnum):
    ...
    MYSQL_FORCE_IMPORT_SQLFILE = EnumField("MYSQL_FORCE_IMPORT_SQLFILE", _("MySQL 强制变更SQL执行"))
    ...
    TENDBCLUSTER_FORCE_IMPORT_SQLFILE = EnumField("TENDBCLUSTER_FORCE_IMPORT_SQLFILE", _("TenDB Cluster 强制变更SQL执行"))
