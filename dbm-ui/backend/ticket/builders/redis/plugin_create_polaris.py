...
class RedisPluginCreatePolarisFlowParamBuilder(builders.FlowParamBuilder):
    controller = NameServiceController.polaris_create

    def format_ticket_data(self):
        """
        {
            "uid": 340,
            "ticket_type": "REDIS_PLUGIN_CREATE_POLARIS",
            "created_by": "admin",
            "cluster_id": 1111
        }
        """
...
@builders.BuilderFactory.register(TicketType.REDIS_PLUGIN_CREATE_POLARIS, iam=ActionEnum.REDIS_LOADBALANCE_MANAGE)
