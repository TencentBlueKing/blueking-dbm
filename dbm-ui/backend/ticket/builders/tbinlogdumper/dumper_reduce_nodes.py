...
class TbinlogdumperReduceNodesDetailSerializer(serializers.Serializer):
    class DumperReduceInfoSerializer(serializers.Serializer):
        cluster_id = serializers.IntegerField(help_text=_("集群ID"))
        reduce_ids = serializers.ListField(help_text=_("dumper部署信息"), child=serializers.IntegerField())

    infos = serializers.ListSerializer(child=DumperReduceInfoSerializer())
