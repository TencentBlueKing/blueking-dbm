...
class HdfsRebootDetailSerializer(BigDataRebootDetailSerializer):
    pass


class HdfsRebootFlowParamBuilder(builders.FlowParamBuilder):
    controller = HdfsController.hdfs_reboot_scene
