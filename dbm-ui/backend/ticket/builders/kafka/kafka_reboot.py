...
class KafkaRebootDetailSerializer(BigDataRebootDetailSerializer):
    pass


class KafkaRebootFlowParamBuilder(builders.FlowParamBuilder):
    controller = KafkaController.kafka_reboot_scene
