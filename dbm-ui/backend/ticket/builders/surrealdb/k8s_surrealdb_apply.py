...
class K8sSurrealDBApplyDetailSerializer(TicketBaseValidateSerializerMixin, serializers.Serializer):
    ...
    bk_cloud_region = serializers.CharField(help_text=_("云区域"))
    k8s_cluser_name = serializers.CharField(help_text=_("K8s 集群名称"))
    ...
    topoName = serializers.CharField(help_text=_("拓扑名称"))
