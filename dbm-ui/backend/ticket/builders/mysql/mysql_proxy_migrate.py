...
@builders.BuilderFactory.register(
    TicketType.MYSQL_PROXY_MIGRATE, is_apply=True, is_recycle=True, iam=ActionEnum.MYSQL_MANAGE
)
class MysqlProxyMigrateFlowBuilder(BaseMySQLHATicketFlowBuilder):
