...
class DorisRebootDetailSerializer(BigDataRebootDetailSerializer):
    pass


class DorisRebootFlowParamBuilder(builders.FlowParamBuilder):
    controller = DorisController.doris_reboot_scene
