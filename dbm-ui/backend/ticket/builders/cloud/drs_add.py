...
class CloudDRSAddDetailSerializer(serializers.Serializer):
    bk_cloud_id = serializers.IntegerField(help_text=_("云区域ID"))
    new_drs = serializers.DictField(help_text=_("新drs机器的部署信息"))


class CloudDRSAddFlowParamBuilder(BaseServiceOperateFlowParamBuilder):
...
@builders.BuilderFactory.register(TicketType.CLOUD_DRS_ADD)
