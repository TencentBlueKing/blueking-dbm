...
class CloudDNSAddDetailSerializer(serializers.Serializer):
    bk_cloud_id = serializers.IntegerField(help_text=_("云区域ID"))
    new_dns = serializers.DictField(help_text=_("新DNS机器的部署信息"))


class CloudDNSAddFlowParamBuilder(BaseServiceOperateFlowParamBuilder):
...
@builders.BuilderFactory.register(TicketType.CLOUD_DNS_ADD)
class CloudDNSReloadFlowBuilder(BaseCloudTicketFlowBuilder):
    serializer = CloudDNSAddDetailSerializer
    inner_flow_builder = CloudDNSAddFlowParamBuilder
