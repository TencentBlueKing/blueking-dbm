...
@pytest.mark.parametrize(
    ...
    [
        ...
        (1, True, True, False, True, ACTION_MANUAL, CONFIRM_AUTH_ERROR),
        (-1, True, None, False, True, ACTION_MANUAL, CONFIRM_AUTH_ERROR),
        # 4 process bad
        ...
        # GSE 探测不确定：DRS 失败 → 人工处理单（避免误替换）
        (1, None, None, False, False, ACTION_MANUAL, CONFIRM_GSE_INCONCLUSIVE),
        (-1, None, None, False, False, ACTION_MANUAL, CONFIRM_GSE_INCONCLUSIVE),
        # GSE 不确定但 DRS 成功 → 修状态
        (1, None, None, True, False, ACTION_FIX_STATUS, CONFIRM_LOGIN_OK),
        # GSE 不确定但鉴权失败 → 人工处理单
        (1, None, None, False, True, ACTION_MANUAL, CONFIRM_AUTH_ERROR),
    ],
)
