...
LIST_COS_CONFIGS_RESPONSE_DATA = [
    {
        "version": "cosinfo.toml",
        "name": "backup_client配置",
        "bk_cloud_id": 0,
        "bk_cloud_name": "test",
        "description": "备份客户端",
        "updated_at": "",
        ...
        "conf_items": [
            {
                "conf_name": "app_attr.bk_biz_id",
                "conf_value": "{{.AppAttr.BkBizId}}",
                "description": "",
                "flag_disable": 0,
                "flag_locked": 0,
                "stage": 0,
                ...
                "up_level_value": None,
                "op_type": "",
                "value_allowed": "[0, 9999999]",
                "need_restart": 0,
                "value_type_sub": "RANGE",
            },
            {
                "conf_name": "app_attr.bk_cloud_id",
                "conf_value": "{{.AppAttr.BkCloudId}}",
                "description": "",
                "flag_disable": 0,
                "flag_locked": 0,
                "stage": 0,
            ...
            {
                "conf_name": "cos_auth.bucket_name",
                "conf_value": "{{.CosAuth.BucketName}}",
                "description": "",
                "flag_disable": 0,
                "flag_locked": 0,
                "stage": 0,
            ...
            {
                "conf_name": "cos_auth.endpoint",
                "conf_value": "{{.CosAuth.Endpoint}}",
                "description": "",
                "flag_disable": 0,
                "flag_locked": 0,
                "stage": 0,
            ...
            {
                "conf_name": "cos_auth.region",
                "conf_value": "{{.CosAuth.Region}}",
                "description": "",
                "flag_disable": 0,
                "flag_locked": 0,
                "stage": 0,
            ...
            {
                "conf_name": "cos_auth.secret_id",
                "conf_value": "{{.CosAuth.SecretId}}",
                "description": "",
                "flag_disable": 0,
                "flag_locked": 0,
                "stage": 0,
            ...
            {
                "conf_name": "cos_auth.secret_key",
                "conf_value": "{{.CosAuth.SecretKey}}",
                "description": "",
                "flag_disable": 0,
                "flag_locked": 0,
                "stage": 0,
            ...
            {
                "conf_name": "cos_auth.storage_type",
                "conf_value": "",
                "description": "",
                "flag_disable": 0,
                "flag_locked": 0,
                ...
                "up_level_value": None,
                "op_type": "",
                "value_allowed": " , hdfs, cos, s3, bkrepo",
                "need_restart": 0,
                "value_type_sub": "ENUM",
            },
        ],
