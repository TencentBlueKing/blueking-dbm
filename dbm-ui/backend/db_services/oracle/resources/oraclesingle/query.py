...
from backend.db_meta.api.cluster.oracle.detail import single_scan_cluster
...
class ListRetrieveResource(query.ListRetrieveResource):
    """查看 oraclesingle 架构的资源"""

    cluster_types = [ClusterType.OracleSingleNone]
    ...
    def _to_cluster_representation(
        ...
        **kwargs,
        ...
        cluster_role_info = {"primaries": primaries}
    ...
    def get_topo_graph(cls, bk_biz_id: int, cluster_id: int) -> dict:
        ...
        graph = single_scan_cluster(cluster).to_dict()
        return graph
