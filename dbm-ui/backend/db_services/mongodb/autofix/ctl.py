...
def is_followup_need_approval() -> bool:
    """PRE 后 ENSURE_START / FIX_STATUS / MANUAL / RELOAD 是否走审批；默认 on。"""
    return get_ctl_value(MongoAutofixCtlItem.FOLLOWUP_NEED_APPROVAL.value).lower() != "off"
