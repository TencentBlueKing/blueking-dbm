...
from backend.db_services.mongodb.permission.db_authorize import mock_data


class MongoDBPreCheckAuthorizeRulesSerializer(serializers.Serializer):
    class MongoDBUserSerializer(serializers.Serializer):
    ...
    mongo_users = serializers.ListSerializer(help_text=_("mongo账户规则"), child=MongoDBUserSerializer())
...
class MongoDBPreCheckAuthorizeRulesResponseSerializer(serializers.Serializer):
