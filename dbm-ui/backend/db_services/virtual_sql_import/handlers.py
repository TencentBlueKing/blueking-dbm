...
from backend.db_services.virtual_sql_import.constants import BKREPO_DBTYPE_SQLFILE_PATH
...
class SQLHandler(object):
    ...
    def upload_sql_file(
        ...
        db_type: DBType = DBType.MySQL.value,
    ) -> List[Dict[str, Any]]:
        """
        将sql文本或者sql文件上传到制品库
        @param bk_biz_id: 业务ID
        ...
        upload_sql_path = BKREPO_DBTYPE_SQLFILE_PATH.format(db_type=db_type, biz=bk_biz_id)
