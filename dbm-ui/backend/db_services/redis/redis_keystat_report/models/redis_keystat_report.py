...
class ReportItem(models.Model):
    ...
    avg_ttl = models.BigIntegerField(default=0, help_text=_("平均TTL"))
    ...
    min_idletime = models.BigIntegerField(default=0, help_text=_("最小空闲时间"))
    min_idletime_show = models.CharField(max_length=255, default="", help_text=_("最近访问时间（带单位）"))
    avg_key_used_bytes = models.BigIntegerField(default=0, help_text=_("单key平均占用内存"))
...
class RankItem(models.Model):
    ...
    key_name = models.CharField(max_length=255, default="", help_text=_("key名称"))
    key_type = models.CharField(max_length=255, default="", help_text=_("key类型"))
    rank_value = models.BigIntegerField(default=0, help_text=_("排行值"))
    ttl = models.BigIntegerField(default=0, help_text=_("TTL"))
    ttl_human = models.CharField(max_length=255, default="", help_text=_("过期时间（带单位）"))
    atime = models.BigIntegerField(default=0, help_text=_("最后访问时间"))
    member = models.BigIntegerField(default=0, help_text=_("成员的数量"))
