...
class PreCheckAuthorizeRulesSerializer(serializers.Serializer):
    ...
    source_ips = serializers.ListField(help_text=_("源ip列表"), child=SourceIpSerializer(), required=False)
...
class PreCheckAuthorizeRulesResponseSerializer(serializers.Serializer):
