...
from .query import SurrealDBSingleListRetrieveResource

REF_NAME = "surrealdbsingle"
...
class ResourceFieldSLZ(serializers.Serializer):
    class Meta:
        swagger_schema_fields = {"example": SurrealDBSingleListRetrieveResource.get_fields()}
