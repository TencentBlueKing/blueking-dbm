...
from backend.db_services.kubernetes.surrealdb.surrealdbsingle import yasg_slz
from backend.db_services.kubernetes.surrealdb.surrealdbsingle.query import SurrealDBSingleListRetrieveResource
...
class SurrealDBSingleResourceViewSet(KubernetesResourceViewSet):
    ...
    list_perm_actions = [
        ...
        ActionEnum.K8S_SURREALDB_MANAGE,
        ActionEnum.K8S_SURREALDB_DESTROY,
        ActionEnum.K8S_SURREALDB_ENABLE_DISABLE,
    ]
