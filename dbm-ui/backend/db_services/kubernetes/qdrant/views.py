...
from backend.db_services.kubernetes.qdrant import constants, yasg_slz
from backend.db_services.kubernetes.qdrant.query import QdrantHaListRetrieveResource
...
class QdrantHaResourceViewSet(KubernetesResourceViewSet):
    query_class = QdrantHaListRetrieveResource
    query_serializer_class = serializers.ListKubernetesResourceSLZ
    db_type = DBType.K8sQdrant
