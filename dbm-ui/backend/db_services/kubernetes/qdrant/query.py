...
"""
from backend.db_meta.api.cluster.qdrantha.detail import scan_cluster
...
class QdrantHaListRetrieveResource(KubernetesBaseListRetrieveResource):
    cluster_types = [ClusterType.K8sQdrantHa]
    instance_roles = [InstanceRole.QDRANT]
    fields = [
