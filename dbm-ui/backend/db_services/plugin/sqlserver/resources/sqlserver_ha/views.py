...
from backend.db_services.sqlserver.resources.sqlserver_ha.views import SQLServerHaViewSet
...
class SQLServerHaApiGwViewSet(BaseOpenAPIViewSet, SQLServerHaViewSet):
    """SQLServer高可用资源"""
