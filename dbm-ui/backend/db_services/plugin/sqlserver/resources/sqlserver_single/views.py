...
from backend.db_services.sqlserver.resources.sqlserver_single.views import SQLServerSingleViewSet
...
class SQLServerSingleApiGwViewSet(BaseOpenAPIViewSet, SQLServerSingleViewSet):
