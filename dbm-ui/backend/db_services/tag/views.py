...
class TagViewSet(AuditedModelViewSet):
    ...
    def related_resources(self, request, *args, **kwargs):
        ...
        return Response(TagHandler.query_related_resources(validated_data["bk_biz_id"], validated_data["ids"]))
    ...
    def batch_create(self, request, *args, **kwargs):
        ...
        """
        validated_data = self.params_validate(self.get_serializer_class())
        return Response(TagHandler.batch_create(validated_data["bk_biz_id"], validated_data["tags"]))
    ...
    def verify_duplicated(self, request, *args, **kwargs):
        ...
        """
        validated_data = self.params_validate(self.get_serializer_class())
        return Response(TagHandler.verify_duplicated(validated_data["bk_biz_id"], validated_data["ids"]))
