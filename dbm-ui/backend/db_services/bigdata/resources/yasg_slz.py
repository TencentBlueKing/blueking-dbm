...
class ResourceFieldSLZ(serializers.Serializer):
    class Meta:
        swagger_schema_fields = {"example": BigDataBaseListRetrieveResource.get_fields()}
...
class XmlResourceSLZ(serializers.Serializer):
    class Meta:
        swagger_schema_fields = {"example": {"hdfs-site.xml": "xxxxxx", "core-site.xml": "xxxxxx"}}
        ref_name = f"{REF_NAME}_XmlResourceSLZ"


class NodesResourceSLZ(serializers.Serializer):
    class Meta:
        swagger_schema_fields = {"example": [{"ip": "127.0.0.1", "node_count": 1, "role": "hot", "status": "alive"}]}
        ref_name = f"{REF_NAME}_NodesResourceSLZ"
