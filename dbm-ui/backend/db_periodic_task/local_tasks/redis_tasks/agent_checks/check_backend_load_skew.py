...
class BackendLoadSkewCheckConfig(BaseCheckConfig):
    setting_key: ClassVar[str] = SystemSettingsEnum.REDIS_BACKEND_LOAD_SKEW_CHECK.value
...
def check_backend_load_skew_task(self, cluster_id: int, config_dict: dict):
    ...
    execute_agent_check(
        agent_code=CheckBackendLoadSkewTask.agent_code,
        prompt_template=CheckBackendLoadSkewTask.prompt_template,
        config=config,
