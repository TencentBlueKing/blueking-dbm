...
class MongoClusterAlarmInputSerializer(serializers.Serializer):
    """MongoDB集群级别告警查询"""
...
class MongoAppAlarmInputSerializer(serializers.Serializer):
    """MongoDB业务级别告警查询"""
...
class MongoAlarmItemSerializer(serializers.Serializer):
    """MongoDB告警项序列化器"""
...
class MongoAlarmItemNamesSerializer(serializers.Serializer):
    """MongoDB告警项序列化器"""

    alert_name = serializers.CharField(help_text=_("告警名称"))
    alert_detail = MongoAlarmItemSerializer(many=True, help_text=_("告警列表"))


class MongoClusterAlarmOutputSerializer(serializers.Serializer):
    """MongoDB集群级别告警输出结果"""

    total_alarms = serializers.IntegerField(help_text=_("总告警数"))
    alarm_detail = MongoAlarmItemNamesSerializer(many=True, help_text=_("告警列表"))


class MongoAppAlarmOutputSerializer(serializers.Serializer):
    """MongoDB业务级别告警输出结果"""
