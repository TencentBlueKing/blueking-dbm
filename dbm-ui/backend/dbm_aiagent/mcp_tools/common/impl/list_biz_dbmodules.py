...
def list_biz_dbmodules(bk_biz_id: int, cluster_type: ClusterType) -> List:
    res = []
    for dbmodule_obj in DBModule.objects.filter(bk_biz_id=bk_biz_id, cluster_type=cluster_type):
