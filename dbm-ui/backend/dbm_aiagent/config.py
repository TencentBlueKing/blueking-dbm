...
BK_APIGW_STAGE_MCP_SERVERS = [
    ...
    {
        "name": "mysql-log",
        "description": """query mysql log info""",
        # 主动授权 app_code
        "target_app_codes": [env.APP_CODE, "ai-dbm"],
        "labels": ["mysql-log"],
        # 是否启用：1-启用，0-停止
    ...
    {
        "name": "resource-replenish",
        "description": """resource host replenish""",
        # 主动授权 app_code
        "target_app_codes": [env.APP_CODE, "ai-dbm"],
        "labels": ["resource-replenish"],
        # 是否启用：1-启用，0-停止
        "status": 1,
        # 是否公开
        "is_public": False,
    ...
    {
        "name": "es-query-meta",
        "description": """Elasticsearch cluster meta information query services""",
        # 主动授权 app_code
        "target_app_codes": [env.APP_CODE, "ai-dbm"],
    ...
    {
        "name": "es-bill",
        "description": """Elasticsearch bill creation services""",
        # 主动授权 app_code
        "target_app_codes": [env.APP_CODE, "ai-dbm"],
        "labels": ["es-bill"],
        # 是否启用：1-启用，0-停止
    ...
    {
        "name": "kafka-rebalance-control",
        "description": """Kafka rebalance ticket progress query and throttle control services""",
        # 主动授权 app_code
        "target_app_codes": [env.APP_CODE, "ai-dbm"],
        "labels": ["kafka-rebalance-control"],
        # 是否启用：1-启用，0-停止
        "status": 1,
        # 是否公开
        "is_public": False,
