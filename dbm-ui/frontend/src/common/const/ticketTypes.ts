...
export enum TicketTypes {
  ...
  MYSQL_PROXY_RESCUE = 'MYSQL_PROXY_RESCUE', // MySQL Proxy 故障重建（整组不可用，按集群整组申请新机重建并下架旧机）
...
export enum TicketTypes {
  ...
  TENDBCLUSTER_SPIDER_LAYER_DR = 'TENDBCLUSTER_SPIDER_LAYER_DR', // Spider 接入层故障重建（整组不可用，按集群整组申请新机重建并下架旧机）
