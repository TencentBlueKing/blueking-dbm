...
export enum TicketTypes {
  ...
  MYSQL_FIXPOINT = 'MYSQL_FIXPOINT', // mysql 构造
...
export enum TicketTypes {
  ...
  TENDBCLUSTER_LOCAL_UPGRADE = 'TENDBCLUSTER_LOCAL_UPGRADE', // spider 原地升级
  TENDBCLUSTER_SPIDER_UPGRADE = 'TENDBCLUSTER_SPIDER_UPGRADE', // Spider 迁移升级
