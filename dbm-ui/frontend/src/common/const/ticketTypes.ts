...
export enum TicketTypes {
  K8S_VICTORIAMETRICS_CLUSTER_APPLY = 'K8S_VICTORIAMETRICS_CLUSTER_APPLY', // VictoriaMetrics 标准集群申请
  K8S_VICTORIAMETRICS_DESTROY = 'K8S_VICTORIAMETRICS_DESTROY', // VictoriaMetrics 删除
  K8S_VICTORIAMETRICS_DISABLE = 'K8S_VICTORIAMETRICS_DISABLE', // VictoriaMetrics 禁用
  K8S_VICTORIAMETRICS_ENABLE = 'K8S_VICTORIAMETRICS_ENABLE', // VictoriaMetrics 启用
  K8S_VICTORIAMETRICS_RESTART = 'K8S_VICTORIAMETRICS_RESTART', // VictoriaMetrics 重启
  K8S_VICTORIAMETRICS_SELECT_APPLY = 'K8S_VICTORIAMETRICS_SELECT_APPLY', // VictoriaMetrics 查询集群申请
}
export enum TicketTypes {
