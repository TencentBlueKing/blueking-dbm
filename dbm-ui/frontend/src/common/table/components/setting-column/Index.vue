...
<script setup lang="ts">
  ...
  useOutSideClick(() => {
    ...
    showColumnFieldList.value.forEach((columnField) => {
      tableRef.showColumn(columnField);
    });
    props
      .getTable()
      .getTableColumn()
      .tableColumn.forEach((columnInfo: VxeTableDefines.ColumnInfo) => {
        if (!showColumnFieldList.value.includes(columnInfo.field)) {
