...
export default class VictoriametricsClusterInstance {
  componentName: string;
  createdTime: string;
  instance_address: string;
  is_clb_enabled: boolean;
  ...
  constructor(payload = {} as VictoriametricsClusterInstance) {
    this.componentName = payload.componentName;
    this.createdTime = payload.createdTime || '';
    this.instance_address = payload.instance_address;
    this.is_clb_enabled = payload.is_clb_enabled;
