...
import SurrealdbSingleModel from './surrealdb-single';

export default class SurrealdbSingleDetail extends SurrealdbSingleModel {
  cluster_entry_details: ClusterEntryDetailModel[];

  constructor(payload = {} as SurrealdbSingleDetail) {
    super(payload);
