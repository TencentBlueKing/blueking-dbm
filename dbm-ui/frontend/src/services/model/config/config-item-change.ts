...
export interface ConfigItemChangeImage {
  conf_value: string;
  description: string;
  flag_disable: number;
  flag_locked: number;
...
export default class ConfigItemChange {
  after_image: ConfigItemChangeImage;
  before_image: ConfigItemChangeImage;
  bk_biz_id: string;
  conf_file: string;
  conf_file_lc: string;
  conf_name: string;
  ...
  constructor(payload = {} as ConfigItemChange) {
    ...
    this.conf_name_lc = payload.conf_name_lc;
    this.conf_type = payload.conf_type;
    this.conf_type_lc = payload.conf_type_lc;
    this.created_at = payload.created_at;
    this.id = payload.id;
    this.level_name = payload.level_name;
    this.level_value = payload.level_value;
