...
export const getList = function (params: Record<string, any> & { bk_biz_id: number }) {
  return http
    .get<ListBase<KafkaModel[]>>(`/apis/bigdata/bizs/${params.bk_biz_id}/kafka/kafka_resources/`, params)
    .then((data) => ({
      ...data,
...
export const getPassword = function (
  ...
  return http
    .get<KafkaPasswordModel>(
      `/apis/bigdata/bizs/${params.bk_biz_id}/kafka/kafka_resources/${params.cluster_id}/get_password/`,
    )
...
export const getListNodes = function (
  ...
  return http
    .get<
      ListBase<Array<KafkaNodeModel>>
    >(`/apis/bigdata/bizs/${params.bk_biz_id}/kafka/kafka_resources/${params.cluster_id}/list_nodes/`, params)
    .then((data) => ({
      ...data,
...
export const getTableFields = function (params: Record<string, any> & { bk_biz_id: number }) {
  return http.get<ListBase<KafkaModel[]>>(
    `/apis/bigdata/bizs/${params.bk_biz_id}/kafka/kafka_resources/get_table_fields/`,
  );
};
...
export const getListInstance = function (params: Record<string, any> & { bk_biz_id: number }) {
  return http
    .get<
      ListBase<KafkaInstanceModel[]>
    >(`/apis/bigdata/bizs/${params.bk_biz_id}/kafka/kafka_resources/list_instances/`, params)
    .then((data) => ({
      ...data,
...
export const getRetrieveInstance = function (params: { bk_biz_id: number }) {
  return http.get<ListBase<KafkaModel[]>>(
    `/apis/bigdata/bizs/${params.bk_biz_id}/kafka/kafka_resources/retrieve_instance/`,
    params,
  );
};
...
export const getClusterDetail = function (params: { bk_biz_id: number; cluster_id: number }) {
  return http
    .get<KafkaModel>(`/apis/bigdata/bizs/${params.bk_biz_id}/kafka/kafka_resources/${params.cluster_id}/`)
...
export const getNodes = function (params: { bk_biz_id: number; cluster_id: number }) {
  return http.get<ListBase<KafkaModel[]>>(
    `/apis/bigdata/bizs/${params.bk_biz_id}/kafka/kafka_resources/${params.cluster_id}/get_nodes/`,
  );
};
...
export const getTopoGraph = function (params: { bk_biz_id: number; cluster_id: number }) {
  return http.get<ListBase<KafkaModel[]>>(
    `/apis/bigdata/bizs/${params.bk_biz_id}/kafka/kafka_resources/${params.cluster_id}/get_topo_graph/`,
  );
};
