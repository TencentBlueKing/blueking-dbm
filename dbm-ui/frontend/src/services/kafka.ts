...
:Promise<ListBase<KafkaModel[]>> {
  return  http.get(`/apis/bigdata/bizs/${params.bk_biz_id}/kafka/kafka_resources/get_table_fields/`);
};
...
:Promise<ListBase<KafkaModel[]>> {
  return http.get(`/apis/bigdata/bizs/${params.bk_biz_id}/kafka/kafka_resources/retrieve_instance/`, params);
};
...
:Promise<ListBase<KafkaModel[]>> {
  return http.get(`/apis/bigdata/bizs/${params.bk_biz_id}/kafka/kafka_resources/${params.cluster_id}/get_nodes/`);
};

// 获取集群拓扑
export const getTopoGraph = function (params: {bk_biz_id: number, cluster_id: number})
:Promise<ListBase<KafkaModel[]>> {
  return http.get(`/apis/bigdata/bizs/${params.bk_biz_id}/kafka/kafka_resources/${params.cluster_id}/get_topo_graph/`);
};
