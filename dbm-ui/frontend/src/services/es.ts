...
export const getList = function (params: Record<string, any> & {bk_biz_id: number}) {
  return http.get<ListBase<EsModel[]>>(`/apis/bigdata/bizs/${params.bk_biz_id}/es/es_resources/`, params)
    .then(data => ({
      ...data,
...
export const getListNodes = function (params: Record<string, any> & {bk_biz_id: number, cluster_id: number}) {
  return http.get<ListBase<Array<EsNodeModel>>>(`/apis/bigdata/bizs/${params.bk_biz_id}/es/es_resources/${params.cluster_id}/list_nodes/`, params)
    .then(data => ({
      ...data,
...
export const getListInstance = function (params: Record<string, any> & {bk_biz_id: number}) {
  return http.get<ListBase<EsInstanceModel[]>>(`/apis/bigdata/bizs/${params.bk_biz_id}/es/es_resources/list_instances/`, params)
    .then(data => ({
      ...data,
