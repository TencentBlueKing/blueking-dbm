 ...
 * 查询资源列表
 */
export const getResources = (params: GetResourcesParams) => http.get<ListBase<ResourceItem[]>>(`${path}/`, params);
 ...
 * 获取集群实例详情
 */
export const getResourceInstanceDetails = (params: {
  instance_address: string,
  cluster_id?: number
}) => http.get<InstanceDetails>(`${path}/retrieve_instance/`, params);
