...
// TODO INTERFACE /apis/bigdata/bizs/{bk_biz_id}/influxdb/influxdb_resources/get_table_fields/

// 获取实例列表
export const getListInstance = function (params: Record<string, any> & {bk_biz_id: number}) {
  return http.get<ListBase<InfluxdbInstanceModel[]>>(`/apis/bigdata/bizs/${params.bk_biz_id}/influxdb/influxdb_resources/list_instances/`, params)
    .then(res => ({
      ...res,
...
// TODO INTERFACE /apis/bigdata/bizs/{bk_biz_id}/influxdb/influxdb_resources/{cluster_id}/get_topo_graph/
