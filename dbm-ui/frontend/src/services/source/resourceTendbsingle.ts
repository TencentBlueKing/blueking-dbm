 ...
 * 查询资源列表
 */
export const getResources = <T>(params: GetResourcesParams) => http.get<ResourcesResult<T>>(`${path}/`, params);
 ...
 * 获取集群实例详情
 */
export const getResourceInstanceDetails = (params: InstanceDetailsParams) => http.get<InstanceDetails>(`${path}/retrieve_instance/`, params);
