...
export const getList = function (params: Record<string, any> & { bk_biz_id: number }) {
  return http
    .get<ListBase<PulsarModel[]>>(`/apis/bigdata/bizs/${params.bk_biz_id}/pulsar/pulsar_resources/`, params)
    .then((data) => ({
      ...data,
...
export const getPassword = function (
  ...
  return http
    .get<PulsarPasswordModel>(
      `/apis/bigdata/bizs/${params.bk_biz_id}/pulsar/pulsar_resources/${params.cluster_id}/get_password/`,
    )
    .then((data) => new PulsarPasswordModel(data));
};

// 获取 ES 集群节点列表信息
export const getListNodes = function (
  params: Record<string, any> & {
    bk_biz_id: number;
    cluster_id: number;
  },
  ...
  return http
    .get<
      ListBase<Array<PulsarNodeModel>>
    >(`/apis/bigdata/bizs/${params.bk_biz_id}/pulsar/pulsar_resources/${params.cluster_id}/list_nodes/`, params)
    .then((data) => ({
      ...data,
...
export const getTableFields = function (params: Record<string, any> & { bk_biz_id: number }) {
  return http.get<ListBase<PulsarModel[]>>(
    `/apis/bigdata/bizs/${params.bk_biz_id}/pulsar/pulsar_resources/get_table_fields/`,
  );
};
...
export const getListInstance = function (params: Record<string, any> & { bk_biz_id: number }) {
  return http
    .get<
      ListBase<PulsarInstanceModel[]>
    >(`/apis/bigdata/bizs/${params.bk_biz_id}/pulsar/pulsar_resources/list_instances/`, params)
    .then((data) => ({
      ...data,
...
export const getRetrieveInstance = function (params: { bk_biz_id: number }) {
  return http.get<ListBase<PulsarModel[]>>(
    `/apis/bigdata/bizs/${params.bk_biz_id}/pulsar/pulsar_resources/retrieve_instance/`,
    params,
  );
};
...
export const getClusterDetail = function (params: { bk_biz_id: number; cluster_id: number }) {
  return http
    .get<PulsarModel>(`/apis/bigdata/bizs/${params.bk_biz_id}/pulsar/pulsar_resources/${params.cluster_id}/`)
...
export const getNodes = function (params: { bk_biz_id: number; cluster_id: number }) {
  return http.get<ListBase<PulsarModel[]>>(
    `/apis/bigdata/bizs/${params.bk_biz_id}/pulsar/pulsar_resources/${params.cluster_id}/get_nodes/`,
  );
};
...
export const getTopoGraph = function (params: { bk_biz_id: number; cluster_id: number }) {
  return http.get<ListBase<PulsarModel[]>>(
    `/apis/bigdata/bizs/${params.bk_biz_id}/pulsar/pulsar_resources/${params.cluster_id}/get_topo_graph/`,
  );
};
