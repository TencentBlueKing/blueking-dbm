...
<template>
  <div class="doris-cluster-replace-box">
    <template v-if="!isEmpty">
      ...
      <div
        v-if="nodeInfoMap.hot.nodeList.length > 0"
        class="replace-item">
      ...
      <div
        v-if="nodeInfoMap.cold.nodeList.length > 0"
        class="replace-item">
        <div class="item-label">
          {{ t('冷节点') }}
        </div>
      ...
      <div
        v-if="nodeInfoMap.observer.nodeList.length > 0"
        class="replace-item">
        <div class="item-label">
          {{ t('Observer节点') }}
        </div>
      ...
      <div
        v-if="nodeInfoMap.follower.nodeList.length > 0"
        class="replace-item">
        <div class="item-label">
          {{ t('Follower节点') }}
        </div>
