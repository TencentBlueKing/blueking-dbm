        ...
        <tr>
          ...
          <th>
            <div class="result-view-box">
              ...
              <span
                v-if="(isError || isValidated) && hostList.length > 0"
                style="color: #ea3636;">
                <I18nT
                  v-if="nodeList.length > hostList.length"
                  keypath="_已选n台_少n台_共nG">
...
<script setup lang="tsx">
  ...
  interface Exposes {
    getValue: () => Promise<{
      old_nodes: Ivalue[],
      new_nodes: Ivalue[],
      resource_spec: TNodeInfo['resourceSpec']
    }>
  }
  ...
  const nodeList = defineModel<TNodeInfo['nodeList']>('nodeList', {
    required: true,
  });
