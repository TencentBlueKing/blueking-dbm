...
<script setup lang="tsx">
  ...
  const followerSpec = resourceSpec?.follower || {} as ResouceSpec['follower'];
  const observerSpec = resourceSpec?.observer || {} as ResouceSpec['observer'];;
  const hotSpec = resourceSpec?.hot || {} as ResouceSpec['hot'];;
  const coldSpec = resourceSpec?.cold || {} as ResouceSpec['cold'];;
