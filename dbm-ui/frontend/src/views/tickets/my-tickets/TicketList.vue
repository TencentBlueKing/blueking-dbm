            ...
            <div
              ...
              <div class="ticket-side__item-title">
                ...
                <BkTag
                  ...
                  :theme="getTagTheme(item.status as StatusTypesStrings)">
...
<script setup lang="ts">
  ...
  import type { TicketsState } from '../common/types';
  import {
    getDate,
    getTagTheme,
    StatusTypes,
    type StatusTypesStrings,
  } from '../common/utils';
  ...
  interface Emits {
    (e: 'change', value: TicketItem | null): void
  }
  ...
  const filters = Object.keys(StatusTypes).map((key: string) => ({
    label: t(StatusTypes[key as StatusTypesStrings]),
    value: key,
  }));
   ...
   * 选中单据
   */
  function handleSelected(data: TicketItem) {
