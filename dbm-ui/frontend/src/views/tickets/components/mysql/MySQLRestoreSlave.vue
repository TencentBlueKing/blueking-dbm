...
<script setup lang="tsx">
  ...
  import type { MysqlIpItem, MySQLRestoreSlaveDetails, TicketDetails } from '@services/types/ticket';

  const props = defineProps({
    ticketDetails: {
      required: true,
      type: Object as PropType<TicketDetails<MySQLRestoreSlaveDetails>>,
    },
  });
