...
<template>
  <div class="spider-manage-toolbox-side">
    <BkInput
...
<script setup lang="ts">
  ...
  import menusConfig from '@views/spider-manage/toolbox-menu';
  ...
  watch(() => userProfileStore.profile, () => {
    const userMenuGroupSortList = userProfileStore.profile[UserPersonalSettings.SPIDER_TOOLBOX_MENUS] as string[] || [];
    ...
    favorRouteNameMap.value = makeMap(userProfileStore.profile[UserPersonalSettings.SPIDER_TOOLBOX_FAVOR] as string[]);
  }, {
    immediate: true,
  });
