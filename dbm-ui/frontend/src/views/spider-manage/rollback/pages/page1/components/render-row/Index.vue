...
<script setup lang="ts">
  ...
  import RenderMode from '@views/mysql/rollback/pages/page1/components/render-row/components/render-mode/Index.vue';
  import RenderBackup from '@views/mysql/rollback/pages/page1/components/render-row/components/RenderBackup.vue';
  import RenderCluster from '@views/mysql/rollback/pages/page1/components/render-row/components/RenderCluster.vue';
  import RenderClusterInputSelect from '@views/mysql/rollback/pages/page1/components/render-row/components/RenderClusterInputSelect.vue';
  import RenderHostInputSelect from '@views/mysql/rollback/pages/page1/components/render-row/components/RenderHostInputSelect.vue';
  import RenderHostSource from '@views/mysql/rollback/pages/page1/components/render-row/components/RenderHostSource.vue';
