...
<template>
  <div class="mongo-manage-toolbox-side">
    <BkInput
...
<script setup lang="ts">
  ...
  import menusConfig from '@views/mongodb-manage/toolbox-menu';
  ...
  watch(() => userProfileStore.profile, () => {
    const userMenuGroupSortList = userProfileStore.profile[UserPersonalSettings.MONGO_TOOLBOX_MENUS] as string[] || [];
    ...
    favorRouteNameMap.value = makeMap(userProfileStore.profile[UserPersonalSettings.MONGO_TOOLBOX_FAVOR] as string[]);
  }, {
    immediate: true,
  });
  ...
  watch(allRenderMenuGroupList, () => {
    userProfileStore.updateProfile({
      label: UserPersonalSettings.MONGO_TOOLBOX_MENUS,
