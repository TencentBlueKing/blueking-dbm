...
<script setup lang="ts">
  import RenderTableHeadColumn from '@views/spiderss-manage/common/render-table/HeadColumn.vue';
  import RenderTable from '@views/spiderss-manage/common/render-table/Index.vue';
