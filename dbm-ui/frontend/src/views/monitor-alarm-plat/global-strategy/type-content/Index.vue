...
<script lang="tsx">
  ...
  export type RowData = UnPromisify<typeof queryMonitorPolicyList>[0];
</script>
<script setup lang="tsx">
  ...
  const columns = [
    ...
    },
    {
      ...
      <div class="notify-box">
        ...
        <span class="dba">{data.targets.toString()}</span>
      </div>
    ),
    },
    {
  ...
  const fetchHostNodes = async () => {
    ...
    tableData.value = ret;
    pagination.value.count = ret.length;
  };
