...
<template>
  <div class="mongodb-instance-list-page">
    <div class="operation-box">
      ...
      <InstanceBatchCopy
        v-db-console="'mongodb.replicaSetInstanceManage.batchCopy'"
        class="ml-8"
      ...
      <InstanceBatchCopy
        ...
        :selected="selectedList" />
      <DropdownExportExcel
        v-db-console="'mongodb.replicaSetInstanceManage.export'"
        class="ml-8"
      ...
      <template #operation>
        <OperationColumn :cluster-type="ClusterTypes.MONGO_REPLICA_SET">
          <template #default="{ data }: { data: MongodbInstanceModel }">
            <div v-db-console="'mongodb.replicaSetInstanceManage.restartInstance'">
...
<script setup lang="tsx">
  ...
  const { settings, updateTableSettings } = useTableSettings(UserPersonalSettings.MONGODB_REPLICA_SET_INSTANCE, {
