...
export const mongoToolboxChildrenRoutes: RouteRecordRaw[] = [
  ...
  createRouteItem(TicketTypes.MONGODB_ADD_SHARD, t('分片集群增加分片')),
  createRouteItem(TicketTypes.MONGODB_REDUCE_SHARD, t('分片集群减少分片')),
  ...
  createRouteItem(TicketTypes.MONGODB_INSTANCE_RELOAD, t('重启')),
  {
