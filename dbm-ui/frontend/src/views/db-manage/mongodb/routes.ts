...
export const mongoToolboxChildrenRoutes: RouteRecordRaw[] = [
  ...
  // },
  createRouteItem(TicketTypes.MONGODB_ADD_SHARD_NODES, {
    navName: t('扩容Shard节点数'),
  }),
  // {
  ...
  // },
  createRouteItem(TicketTypes.MONGODB_REDUCE_SHARD_NODES, {
    navName: t('缩容Shard节点数'),
  }),
  // {
  ...
  // },
  createRouteItem(TicketTypes.MONGODB_CUTOFF, {
    navName: t('整机替换'),
  }),
  {
  ...
  // },
  createRouteItem(TicketTypes.MONGODB_REMOVE_NS, {
    navName: t('清档'),
  }),
  // {
  //   path: 'db-clear/:page?',
