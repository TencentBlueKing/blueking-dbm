...
export const useRenderGraph = (props: ClusterTopoProps) => {
  ...
  const apiMap: Record<string, (params: any) => Promise<Record<string, any>>> = {
    ...
    sqlserver_ha: retrieveSqlserverHaInstance,
    sqlserver_single: retrieveSqlserverSingleInstance,
