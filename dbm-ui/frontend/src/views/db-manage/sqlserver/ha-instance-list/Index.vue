  ...
  <div class="sqlserver-ha-instance-list-page">
    <div class="operation-box">
      ...
      <InstanceBatchCopy
        ...
        :selected="selectedList" />
      <DropdownExportExcel
        v-db-console="'sqlserver.haInstanceManage.export'"
        class="ml-8"
...
<script setup lang="tsx">
  ...
  const { settings, updateTableSettings } = useTableSettings(UserPersonalSettings.SQLSERVER_HA_INSTANCE_SETTINGS, {
  ...
  const getBatchCopyData = () => {
    return instanceTableRef.value!.getAllData<SqlserverhaInstanceModel>();
  };
