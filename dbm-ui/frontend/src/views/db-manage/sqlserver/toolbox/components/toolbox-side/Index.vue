...
<template>
  <div class="sqlserver-manage-toolbox-side">
    <BkInput
...
<script setup lang="ts">
  ...
  import menusConfig from '@views/db-manage/sqlserver/toolbox-menu';
  ...
  watch(
    ...
    () => {
      const userMenuGroupSortList =
        (userProfileStore.profile[UserPersonalSettings.SQLSERVER_TOOLBOX_MENUS] as string[]) || [];
      ...
      favorRouteNameMap.value = makeMap(
        userProfileStore.profile[UserPersonalSettings.SQLSERVER_TOOLBOX_FAVOR] as string[],
      );
    },
    {
      immediate: true,
  ...
  watch(allRenderMenuGroupList, () => {
    userProfileStore.updateProfile({
      label: UserPersonalSettings.SQLSERVER_TOOLBOX_MENUS,
