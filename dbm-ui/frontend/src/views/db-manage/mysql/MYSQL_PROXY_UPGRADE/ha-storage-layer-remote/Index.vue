  ...
  <SmartAction>
    <EditableTable
      ...
      <EditableRow
        ...
        <NewMasterSlaveHostColumn v-model="item.new_master_slave_host" />
...
<script lang="ts" setup>
  ...
  import NewMasterSlaveHostColumn from './components/NewMasterSlaveHostColumn.vue';
      ...
      createTicketRun({
        details: {
          ...
          infos: formData.tableData.map((item) => ({
            ...
            new_master: item.new_master_slave_host[0],
            new_slave: item.new_master_slave_host[1],
