...
<template>
  <div
    ref="rootRef"
    class="mysql-upgrade-inner-select"
    :class="{
      'mysql-upgrade-inner-select-plain': isPlain,
...
<script setup lang="ts">
  ...
  onMounted(() => {
    const theme = ['mysql-upgrade-inner-select', 'light'];
    if (slots.footer) {
      theme.push('mysql-upgrade-inner-select-footer');
    }
...
<style lang="less">
  ...
  .mysql-upgrade-inner-select-plain {
    &.mysql-upgrade-inner-select {
      height: 22px;
  ...
  .tippy-box[data-theme~='mysql-upgrade-inner-select'] {
    .tippy-content {
      padding: 8px 0;
      font-size: 12px;
      line-height: 32px;
  ...
  .tippy-box[data-theme~='mysql-upgrade-inner-select-footer'] {
    .tippy-content {
      padding: 8px 0 0;
    }
  }
