...
<script setup lang="ts">
  ...
  import BackupRecordColumn from '@views/db-manage/mysql/MYSQL_FIXPOINT/components/backup-record-column/Index.vue';
  import ConflictDbColumn from '@views/db-manage/mysql/MYSQL_FIXPOINT/components/conflict-db-column/Index.vue';
  import TimeBackupRecordColumn from '@views/db-manage/mysql/MYSQL_FIXPOINT/components/time-backup-record-column/Index.vue';
