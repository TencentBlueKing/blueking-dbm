...
<template>
  <tr>
    ...
    <td style="padding: 0">
      <RenderBackup
        ref="backupSourceRef"
        :list="backupSourceList.slice(0, 1)"
...
<script setup lang="ts">
  ...
  import RenderMode, {
    BackupTypes,
  } from '@views/db-manage/mysql/rollback/pages/page1/components/render-row/components/render-mode/Index.vue';
  import RenderBackup, {
    backupSourceList,
    BackupSources,
  } from '@views/db-manage/mysql/rollback/pages/page1/components/render-row/components/RenderBackup.vue';
  ...
  import RenderClusterInputSelect from '@views/db-manage/tendb-cluster/rollback/pages/page1/components/render-row/components/RenderClusterInputSelect.vue';
