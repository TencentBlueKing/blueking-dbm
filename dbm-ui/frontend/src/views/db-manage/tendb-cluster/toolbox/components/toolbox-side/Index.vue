...
<script setup lang="ts">
  ...
  import menusConfig from '@views/db-manage/tendb-cluster/toolbox-menu';
  ...
  watch(
    ...
    () => {
      const userMenuGroupSortList =
        (userProfileStore.profile[UserPersonalSettings.SPIDER_TOOLBOX_MENUS] as string[]) || [];
      ...
      favorRouteNameMap.value = makeMap(
        userProfileStore.profile[UserPersonalSettings.SPIDER_TOOLBOX_FAVOR] as string[],
      );
    },
    {
      immediate: true,
