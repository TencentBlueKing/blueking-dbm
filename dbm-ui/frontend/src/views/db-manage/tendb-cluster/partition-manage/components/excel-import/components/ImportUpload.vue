...
<script setup lang="ts">
  ...
  import DbUpload, { type UploadRequestOptions } from '@components/db-upload';
  ...
  type Emits = {
    (e: 'file-ready', fileData: unknown[], file: File): void;
    (e: 'file-removed'): void;
  ...
  const handleUploadSuccess = (file: any) => {
    ...
    emit('file-ready', file.response as unknown[], file.raw);
  };
