...
<template>
  <div class="tendbcluster-sql-execute-log-page">
    <Component
      :is="renderStatusCom"
      :remark="semanticData.remark" />
    <div
...
<script setup lang="ts">
  ...
  const semanticData = shallowRef({} as SemanticDataModel);
      ...
      if (flowStatus.value === 'successed' && !isViewResultLog) {
        router.push({
          ...
          query: {
            ...
            ticketMode: semanticData.value.ticket_mode.mode,
          },
        });
      }
    },
...
<style lang="less">
  .tendbcluster-sql-execute-log-page {
    .log-layout {
      display: flex;
      width: 928px;
      margin: 0 auto;
