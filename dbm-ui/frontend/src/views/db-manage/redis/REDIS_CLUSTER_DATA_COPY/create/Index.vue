...
<script setup lang="tsx">
  ...
  onMounted(() => {
    const redisDbDataRecordRecopy = localStorage.getItem(LocalStorageKeys.REDIS_DB_DATA_RECORD_RECOPY);
    if (!redisDbDataRecordRecopy) {
      return;
    }
    const item = JSON.parse(redisDbDataRecordRecopy) as RedisDSTHistoryJobModel;
