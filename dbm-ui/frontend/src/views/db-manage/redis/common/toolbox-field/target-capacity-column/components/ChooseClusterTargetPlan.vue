...
<script setup lang="tsx">
  ...
  const isMemoryType = computed(() => [ClusterTypes.TWEMPROXY_REDIS_INSTANCE, ClusterTypes.PREDIXY_REDIS_CLUSTER].includes(props.cluster.cluster_type as ClusterTypes));
