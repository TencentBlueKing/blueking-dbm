<template>
  <div class="redis-instance-list-page">
    <div class="operation-box">
      <InstanceBatchCopy
        v-db-console="'redis.haInstanceManage.batchCopy'"
      ...
      <InstanceBatchCopy
        ...
        :selected="selectedList" />
      <DropdownExportExcel
        v-db-console="'redis.haInstanceManage.export'"
        class="ml-8"
...
<script setup lang="tsx">
  ...
  const { settings, updateTableSettings } = useTableSettings(UserPersonalSettings.REDIS_HA_INSTANCE_SETTINGS, {
