          ...
          <div
            ...
            <BkFormItem
              ...
              <div class="resource-pool-item">
                ...
                <ResourcePreview
                  v-model:tag-list="formData.details.resource_spec.follower.labels"
                  :biz-id="formData.bk_biz_id"
                  :params="{
                    ...
                    resource_types: [DBTypes.DORIS, 'PUBLIC'],
                    spec_id: Number(formData.details.resource_spec.follower.spec_id),
                    labels: formData.details.resource_spec.follower.labels.map((item) => item.id).join(','),
                  }"
                  property="details.resource_spec.follower.labels" />
                <BkFormItem
                  :label="t('数量')"
            ...
            <BkFormItem :label="t('Observer节点')">
              <div class="resource-pool-item">
                ...
                <ResourcePreview
                  v-model:tag-list="formData.details.resource_spec.observer.labels"
                  :biz-id="formData.bk_biz_id"
                  :params="{
                    city: formData.details.city_name,
                    subzones: formData.details.sub_zone_names.join('，'),
                    ...
                    for_bizs: formData.bk_biz_id ? [formData.bk_biz_id, 0] : [0],
                    resource_types: [DBTypes.DORIS, 'PUBLIC'],
                    spec_id: Number(formData.details.resource_spec.observer.spec_id),
                    labels: formData.details.resource_spec.observer.labels.map((item) => item.id).join(','),
                  }"
                  property="details.resource_spec.observer.labels" />
                <BkFormItem
                  :label="t('数量')"
            ...
            <BkFormItem :label="t('温节点')">
              <div class="resource-pool-item">
                ...
                <ResourcePreview
                  v-model:tag-list="formData.details.resource_spec.warm.labels"
                  :biz-id="formData.bk_biz_id"
                  :params="{
                    city: formData.details.city_name,
                    subzones: formData.details.sub_zone_names.join('，'),
                    ...
                    for_bizs: formData.bk_biz_id ? [formData.bk_biz_id, 0] : [0],
                    resource_types: [DBTypes.DORIS, 'PUBLIC'],
                    spec_id: Number(formData.details.resource_spec.warm.spec_id),
                    labels: formData.details.resource_spec.warm.labels.map((item) => item.id).join(','),
                  }"
                  property="details.resource_spec.warm.labels" />
                <BkFormItem
                  :label="t('数量')"
...
<script setup lang="ts">
  ...
  // 更新节点IP
  const handleIpListChange = (data: HostInfo[], nodeType: NodeType) => {
          ...
          const result = {
            ...
            resource_spec: {
              follower: {
                ...
                label_names: details.resource_spec.follower.labels.map((item: { value: string }) => item.value),
                labels: details.resource_spec.follower.labels.map((item: { id: number }) => String(item.id)),
              },
            },
          };
          ...
          if (observerCount > 0) {
            Object.assign(result.resource_spec, {
              observer: {
                ...
                ...regionAndDisasterParams,
                count: observerCount,
                label_names: details.resource_spec.observer.labels.map((item: { value: string }) => item.value),
                labels: details.resource_spec.observer.labels.map((item: { id: number }) => String(item.id)),
              },
            });
          }
          if (hotCount > 0) {
          ...
          if (warmCount > 0) {
            Object.assign(result.resource_spec, {
              warm: {
                ...
                ...regionAndDisasterParams,
                count: warmCount,
                label_names: details.resource_spec.warm.labels.map((item: { value: string }) => item.value),
                labels: details.resource_spec.warm.labels.map((item: { id: number }) => String(item.id)),
              },
            });
          }
          return result;
