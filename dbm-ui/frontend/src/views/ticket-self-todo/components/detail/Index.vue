...
<script setup lang="tsx">
  ...
  import BaseInfo from '@views/tickets/my-todos/components/details/components/BaseInfo.vue';
  import DemandInfo from '@views/tickets/my-todos/components/details/components/Demand.vue';
  import FlowInfo from '@views/tickets/my-todos/components/details/components/flow/Index.vue';
