...
<script setup lang="ts">
  ...
  const handleNodeClick = (
    ...
    if (selectedTreeNode.value?.nodeType === 'biz') {
      emits('change', {
        bk_biz_id: selectedTreeNode.value.id,
      });
    } else if (selectedTreeNode.value?.nodeType === 'module') {
      emits('change', {
        db_module_id: selectedTreeNode.value.id,
      });
    } else {
      emits('change', {
        bk_biz_id: undefined,
