<template>
  <div class="machine-selector-related-instances">
    <div
      v-for="item in displayList"
      :key="item.instance"
      class="machine-selector-related-instances-item">
...
<style lang="less">
  .machine-selector-related-instances {
    padding: 6px 0;

    .machine-selector-related-instances-item {
      line-height: 18px;
    }
