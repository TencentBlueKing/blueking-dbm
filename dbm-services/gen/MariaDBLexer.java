// Generated from /Users/xfwduke/DBM/blueking-dbm/dbm-services/mysql/db-tools/dbactuator/pkg/components/mysql/grant/import_grants_file/internal/parser/MariaDBLexer.g4 by ANTLR 4.13.2
...
public class MariaDBLexer extends Lexer {
	...
	public static final int
		...
		LONGTEXT=239, ENUM=240, VARYING=241, SERIAL=242, VECTOR=243, YEAR_MONTH=244, 
		DAY_HOUR=245, DAY_MINUTE=246, DAY_SECOND=247, HOUR_MINUTE=248, HOUR_SECOND=249, 
		MINUTE_SECOND=250, SECOND_MICROSECOND=251, MINUTE_MICROSECOND=252, HOUR_MICROSECOND=253, 
		DAY_MICROSECOND=254, JSON_ARRAY=255, JSON_ARRAYAGG=256, JSON_ARRAY_APPEND=257, 
		JSON_ARRAY_INSERT=258, JSON_CONTAINS=259, JSON_CONTAINS_PATH=260, JSON_DEPTH=261, 
		JSON_EXTRACT=262, JSON_INSERT=263, JSON_KEYS=264, JSON_LENGTH=265, JSON_MERGE=266, 
		JSON_MERGE_PATCH=267, JSON_MERGE_PRESERVE=268, JSON_OBJECT=269, JSON_OBJECTAGG=270, 
		JSON_OVERLAPS=271, JSON_PRETTY=272, JSON_QUOTE=273, JSON_REMOVE=274, JSON_REPLACE=275, 
		JSON_SCHEMA_VALID=276, JSON_SCHEMA_VALIDATION_REPORT=277, JSON_SEARCH=278, 
		JSON_SET=279, JSON_STORAGE_FREE=280, JSON_STORAGE_SIZE=281, JSON_TABLE=282, 
		JSON_TYPE=283, JSON_UNQUOTE=284, JSON_VALID=285, JSON_VALUE=286, NESTED=287, 
		ORDINALITY=288, PATH=289, AVG=290, BIT_AND=291, BIT_OR=292, BIT_XOR=293, 
		COUNT=294, CUME_DIST=295, DENSE_RANK=296, FIRST_VALUE=297, GROUP_CONCAT=298, 
		LAG=299, LAST_VALUE=300, LEAD=301, MAX=302, MIN=303, NTILE=304, NTH_VALUE=305, 
		PERCENT_RANK=306, RANK=307, ROW_NUMBER=308, STD=309, STDDEV=310, STDDEV_POP=311, 
		STDDEV_SAMP=312, SUM=313, VAR_POP=314, VAR_SAMP=315, VARIANCE=316, CURRENT_DATE=317, 
		CURRENT_TIME=318, CURRENT_TIMESTAMP=319, LOCALTIME=320, CURDATE=321, CURTIME=322, 
		DATE_ADD=323, DATE_SUB=324, EXTRACT=325, LOCALTIMESTAMP=326, NOW=327, 
		POSITION=328, SUBSTR=329, SUBSTRING=330, SYSDATE=331, TRIM=332, UTC_DATE=333, 
		UTC_TIME=334, UTC_TIMESTAMP=335, ACCOUNT=336, ACTION=337, AFTER=338, AGGREGATE=339, 
		ALGORITHM=340, ANY=341, AT=342, AUTHORS=343, AUTOCOMMIT=344, AUTOEXTEND_SIZE=345, 
		AUTO=346, AUTO_INCREMENT=347, AVG_ROW_LENGTH=348, BEGIN=349, BINLOG=350, 
		BIT=351, BLOCK=352, BOOL=353, BOOLEAN=354, BTREE=355, CACHE=356, CASCADED=357, 
		CHAIN=358, CHANGED=359, CHANNEL=360, CHECKSUM=361, PAGE_CHECKSUM=362, 
		CIPHER=363, CLASS_ORIGIN=364, CLIENT=365, CLOSE=366, CLUSTERING=367, COALESCE=368, 
		CODE=369, COLUMNS=370, COLUMN_FORMAT=371, COLUMN_NAME=372, COMMENT=373, 
		COMMIT=374, COMPACT=375, COMPLETION=376, COMPRESSED=377, COMPRESSION=378, 
		CONCURRENT=379, CONNECT=380, CONNECTION=381, CONSISTENT=382, CONSTRAINT_CATALOG=383, 
		CONSTRAINT_SCHEMA=384, CONSTRAINT_NAME=385, CONTAINS=386, CONTEXT=387, 
		CONTRIBUTORS=388, COPY=389, CPU=390, CYCLE=391, CURSOR_NAME=392, DATA=393, 
		DATAFILE=394, DEALLOCATE=395, DEFAULT_AUTH=396, DEFINER=397, DELAY_KEY_WRITE=398, 
		DES_KEY_FILE=399, DIRECTORY=400, DISABLE=401, DISCARD=402, DISK=403, DO=404, 
		DUMPFILE=405, DUPLICATE=406, DYNAMIC=407, ENABLE=408, ENCRYPTED=409, ENCRYPTION=410, 
		ENCRYPTION_KEY_ID=411, END=412, ENDS=413, ENGINE=414, ENGINES=415, ERROR=416, 
		ERRORS=417, ESCAPE=418, EVEN=419, EVENT=420, EVENTS=421, EVERY=422, EXCHANGE=423, 
		EXCLUSIVE=424, EXPIRE=425, EXPORT=426, EXTENDED=427, EXTENT_SIZE=428, 
		FAILED_LOGIN_ATTEMPTS=429, FAST=430, FAULTS=431, FIELDS=432, FILE_BLOCK_SIZE=433, 
		FILTER=434, FIRST=435, FIXED=436, FLUSH=437, FOLLOWING=438, FOLLOWS=439, 
		FOUND=440, FULL=441, FUNCTION=442, GENERAL=443, GLOBAL=444, GRANTS=445, 
		GROUP_REPLICATION=446, HANDLER=447, HASH=448, HELP=449, HISTORY=450, HOST=451, 
		HOSTS=452, IDENTIFIED=453, IGNORE_SERVER_IDS=454, IMPORT=455, INCREMENT=456, 
		INDEXES=457, INITIAL_SIZE=458, INPLACE=459, INSERT_METHOD=460, INSTALL=461, 
		INSTANCE=462, INSTANT=463, INVISIBLE=464, INVOKER=465, IO=466, IO_THREAD=467, 
		IPC=468, ISOLATION=469, ISSUER=470, JSON=471, KEY_BLOCK_SIZE=472, LANGUAGE=473, 
		LAST=474, LEAVES=475, LESS=476, LEVEL=477, LIST=478, LOCAL=479, LOCALES=480, 
		LOGFILE=481, LOGS=482, MASTER=483, MASTER_AUTO_POSITION=484, MASTER_CONNECT_RETRY=485, 
		MASTER_DELAY=486, MASTER_HEARTBEAT_PERIOD=487, MASTER_HOST=488, MASTER_LOG_FILE=489, 
		MASTER_LOG_POS=490, MASTER_PASSWORD=491, MASTER_PORT=492, MASTER_RETRY_COUNT=493, 
		MASTER_SSL=494, MASTER_SSL_CA=495, MASTER_SSL_CAPATH=496, MASTER_SSL_CERT=497, 
		MASTER_SSL_CIPHER=498, MASTER_SSL_CRL=499, MASTER_SSL_CRLPATH=500, MASTER_SSL_KEY=501, 
		MASTER_TLS_VERSION=502, MASTER_USER=503, MAX_CONNECTIONS_PER_HOUR=504, 
		MAX_QUERIES_PER_HOUR=505, MAX_ROWS=506, MAX_SIZE=507, MAX_UPDATES_PER_HOUR=508, 
		MAX_USER_CONNECTIONS=509, MEDIUM=510, MEMBER=511, MERGE=512, MESSAGE_TEXT=513, 
		MID=514, MIGRATE=515, MIN_ROWS=516, MODE=517, MODIFY=518, MUTEX=519, MYSQL=520, 
		MYSQL_ERRNO=521, NAME=522, NAMES=523, NCHAR=524, NEVER=525, NEXT=526, 
		NO=527, NOCACHE=528, NOCOPY=529, NOCYCLE=530, NOMAXVALUE=531, NOMINVALUE=532, 
		NOWAIT=533, NODEGROUP=534, NONE=535, ODBC=536, OFFLINE=537, OFFSET=538, 
		OF=539, OJ=540, OLD_PASSWORD=541, ONE=542, ONLINE=543, ONLY=544, OPEN=545, 
		OPTIMIZER_COSTS=546, OPTIONS=547, OWNER=548, PACK_KEYS=549, PAGE=550, 
		PAGE_COMPRESSED=551, PAGE_COMPRESSION_LEVEL=552, PARSER=553, PARTIAL=554, 
		PARTITIONING=555, PARTITIONS=556, PASSWORD=557, PASSWORD_LOCK_TIME=558, 
		PHASE=559, PLUGIN=560, PLUGIN_DIR=561, PLUGINS=562, PORT=563, PRECEDES=564, 
		PRECEDING=565, PREPARE=566, PRESERVE=567, PREV=568, PROCESSLIST=569, PROFILE=570, 
		PROFILES=571, PROXY=572, QUERY=573, QUERY_RESPONSE_TIME=574, QUICK=575, 
		REBUILD=576, RECOVER=577, RECURSIVE=578, REDO_BUFFER_SIZE=579, REDUNDANT=580, 
		RELAY=581, RELAY_LOG_FILE=582, RELAY_LOG_POS=583, RELAYLOG=584, REMOVE=585, 
		REORGANIZE=586, REPAIR=587, REPLICATE_DO_DB=588, REPLICATE_DO_TABLE=589, 
		REPLICATE_IGNORE_DB=590, REPLICATE_IGNORE_TABLE=591, REPLICATE_REWRITE_DB=592, 
		REPLICATE_WILD_DO_TABLE=593, REPLICATE_WILD_IGNORE_TABLE=594, REPLICATION=595, 
		RESET=596, RESTART=597, RESUME=598, RETURNED_SQLSTATE=599, RETURNING=600, 
		RETURNS=601, REUSE=602, ROLE=603, ROLLBACK=604, ROLLUP=605, ROTATE=606, 
		ROW=607, ROWS=608, ROW_FORMAT=609, RTREE=610, SAVEPOINT=611, SCHEDULE=612, 
		SECURITY=613, SEQUENCE=614, SERVER=615, SESSION=616, SHARE=617, SHARED=618, 
		SIGNED=619, SIMPLE=620, SLAVE=621, SLAVES=622, SLOW=623, SNAPSHOT=624, 
		SOCKET=625, SOME=626, SONAME=627, SOUNDS=628, SOURCE=629, SQL_AFTER_GTIDS=630, 
		SQL_AFTER_MTS_GAPS=631, SQL_BEFORE_GTIDS=632, SQL_BUFFER_RESULT=633, SQL_CACHE=634, 
		SQL_NO_CACHE=635, SQL_THREAD=636, START=637, STARTS=638, STATS_AUTO_RECALC=639, 
		STATS_PERSISTENT=640, STATS_SAMPLE_PAGES=641, STATUS=642, STOP=643, STORAGE=644, 
		STORED=645, STRING=646, SUBCLASS_ORIGIN=647, SUBJECT=648, SUBPARTITION=649, 
		SUBPARTITIONS=650, SUSPEND=651, SWAPS=652, SWITCHES=653, TABLE_NAME=654, 
		TABLESPACE=655, TABLE_TYPE=656, TEMPORARY=657, TEMPTABLE=658, THAN=659, 
		TRADITIONAL=660, TRANSACTION=661, TRANSACTIONAL=662, TRIGGERS=663, TRUNCATE=664, 
		TYPES=665, UNBOUNDED=666, UNDEFINED=667, UNDOFILE=668, UNDO_BUFFER_SIZE=669, 
		UNINSTALL=670, UNKNOWN=671, UNTIL=672, UPGRADE=673, USER=674, USE_FRM=675, 
		USER_RESOURCES=676, VALIDATION=677, VALUE=678, VARIABLES=679, VIEW=680, 
		VIRTUAL=681, VISIBLE=682, WAIT=683, WARNINGS=684, WINDOW=685, WITHOUT=686, 
		WORK=687, WRAPPER=688, WSREP_MEMBERSHIP=689, WSREP_STATUS=690, X509=691, 
		XA=692, XML=693, YES=694, EUR=695, USA=696, JIS=697, ISO=698, INTERNAL=699, 
		QUARTER=700, MONTH=701, DAY=702, HOUR=703, MINUTE=704, WEEK=705, SECOND=706, 
		MICROSECOND=707, USER_STATISTICS=708, CLIENT_STATISTICS=709, INDEX_STATISTICS=710, 
		TABLE_STATISTICS=711, ADMIN=712, APPLICATION_PASSWORD_ADMIN=713, AUDIT_ADMIN=714, 
		BACKUP_ADMIN=715, BINLOG_ADMIN=716, BINLOG_ENCRYPTION_ADMIN=717, CLONE_ADMIN=718, 
		CONNECTION_ADMIN=719, ENCRYPTION_KEY_ADMIN=720, EXECUTE=721, FILE=722, 
		FIREWALL_ADMIN=723, FIREWALL_USER=724, FLUSH_OPTIMIZER_COSTS=725, FLUSH_STATUS=726, 
		FLUSH_TABLES=727, FLUSH_USER_RESOURCES=728, GROUP_REPLICATION_ADMIN=729, 
		INNODB_REDO_LOG_ARCHIVE=730, INNODB_REDO_LOG_ENABLE=731, INVOKE=732, LAMBDA=733, 
		NDB_STORED_USER=734, PASSWORDLESS_USER_ADMIN=735, PERSIST_RO_VARIABLES_ADMIN=736, 
		PRIVILEGES=737, PROCESS=738, RELOAD=739, REPLICATION_APPLIER=740, REPLICATION_SLAVE_ADMIN=741, 
		RESOURCE_GROUP_ADMIN=742, RESOURCE_GROUP_USER=743, ROLE_ADMIN=744, ROUTINE=745, 
		S3=746, SERVICE_CONNECTION_ADMIN=747, SESSION_VARIABLES_ADMIN=748, SET_USER_ID=749, 
		SHOW_ROUTINE=750, SHUTDOWN=751, SUPER=752, SYSTEM_VARIABLES_ADMIN=753, 
		TABLES=754, TABLE_ENCRYPTION_ADMIN=755, VERSION_TOKEN_ADMIN=756, XA_RECOVER_ADMIN=757, 
		ARMSCII8=758, ASCII=759, BIG5=760, CP1250=761, CP1251=762, CP1256=763, 
		CP1257=764, CP850=765, CP852=766, CP866=767, CP932=768, DEC8=769, EUCJPMS=770, 
		EUCKR=771, GB18030=772, GB2312=773, GBK=774, GEOSTD8=775, GREEK=776, HEBREW=777, 
		HP8=778, KEYBCS2=779, KOI8R=780, KOI8U=781, LATIN1=782, LATIN2=783, LATIN5=784, 
		LATIN7=785, MACCE=786, MACROMAN=787, SJIS=788, SWE7=789, TIS620=790, UCS2=791, 
		UJIS=792, UTF16=793, UTF16LE=794, UTF32=795, UTF8=796, UTF8MB3=797, UTF8MB4=798, 
		ARCHIVE=799, BLACKHOLE=800, CSV=801, FEDERATED=802, INNODB=803, MEMORY=804, 
		MRG_MYISAM=805, MYISAM=806, NDB=807, NDBCLUSTER=808, PERFORMANCE_SCHEMA=809, 
		TOKUDB=810, REPEATABLE=811, COMMITTED=812, UNCOMMITTED=813, SERIALIZABLE=814, 
		GEOMETRYCOLLECTION=815, GEOMCOLLECTION=816, GEOMETRY=817, LINESTRING=818, 
		MULTILINESTRING=819, MULTIPOINT=820, MULTIPOLYGON=821, POINT=822, POLYGON=823, 
		ABS=824, ACOS=825, ADDDATE=826, ADDTIME=827, AES_DECRYPT=828, AES_ENCRYPT=829, 
		AREA=830, ASBINARY=831, ASIN=832, ASTEXT=833, ASWKB=834, ASWKT=835, ASYMMETRIC_DECRYPT=836, 
		ASYMMETRIC_DERIVE=837, ASYMMETRIC_ENCRYPT=838, ASYMMETRIC_SIGN=839, ASYMMETRIC_VERIFY=840, 
		ATAN=841, ATAN2=842, BENCHMARK=843, BIN=844, BIT_COUNT=845, BIT_LENGTH=846, 
		BUFFER=847, CATALOG_NAME=848, CEIL=849, CEILING=850, CENTROID=851, CHARACTER_LENGTH=852, 
		CHARSET=853, CHAR_LENGTH=854, COERCIBILITY=855, COLLATION=856, COMPRESS=857, 
		CONCAT=858, CONCAT_WS=859, CONNECTION_ID=860, CONV=861, CONVERT_TZ=862, 
		COS=863, COT=864, CRC32=865, CREATE_ASYMMETRIC_PRIV_KEY=866, CREATE_ASYMMETRIC_PUB_KEY=867, 
		CREATE_DH_PARAMETERS=868, CREATE_DIGEST=869, CROSSES=870, DATEDIFF=871, 
		DATE_FORMAT=872, DAYNAME=873, DAYOFMONTH=874, DAYOFWEEK=875, DAYOFYEAR=876, 
		DECODE=877, DEGREES=878, DES_DECRYPT=879, DES_ENCRYPT=880, DIMENSION=881, 
		DISJOINT=882, ELT=883, ENCODE=884, ENCRYPT=885, ENDPOINT=886, ENGINE_ATTRIBUTE=887, 
		ENVELOPE=888, EQUALS=889, EXP=890, EXPORT_SET=891, EXTERIORRING=892, EXTRACTVALUE=893, 
		FIELD=894, FIND_IN_SET=895, FLOOR=896, FORMAT=897, FOUND_ROWS=898, FROM_BASE64=899, 
		FROM_DAYS=900, FROM_UNIXTIME=901, GEOMCOLLFROMTEXT=902, GEOMCOLLFROMWKB=903, 
		GEOMETRYCOLLECTIONFROMTEXT=904, GEOMETRYCOLLECTIONFROMWKB=905, GEOMETRYFROMTEXT=906, 
		GEOMETRYFROMWKB=907, GEOMETRYN=908, GEOMETRYTYPE=909, GEOMFROMTEXT=910, 
		GEOMFROMWKB=911, GET_FORMAT=912, GET_LOCK=913, GLENGTH=914, GREATEST=915, 
		GTID_SUBSET=916, GTID_SUBTRACT=917, HEX=918, IFNULL=919, INET6_ATON=920, 
		INET6_NTOA=921, INET_ATON=922, INET_NTOA=923, INSTR=924, INTERIORRINGN=925, 
		INTERSECTS=926, ISCLOSED=927, ISEMPTY=928, ISNULL=929, ISSIMPLE=930, IS_FREE_LOCK=931, 
		IS_IPV4=932, IS_IPV4_COMPAT=933, IS_IPV4_MAPPED=934, IS_IPV6=935, IS_USED_LOCK=936, 
		LAST_INSERT_ID=937, LCASE=938, LEAST=939, LENGTH=940, LINEFROMTEXT=941, 
		LINEFROMWKB=942, LINESTRINGFROMTEXT=943, LINESTRINGFROMWKB=944, LN=945, 
		LOAD_FILE=946, LOCATE=947, LOG=948, LOG10=949, LOG2=950, LOWER=951, LPAD=952, 
		LTRIM=953, MAKEDATE=954, MAKETIME=955, MAKE_SET=956, MASTER_POS_WAIT=957, 
		MBRCONTAINS=958, MBRDISJOINT=959, MBREQUAL=960, MBRINTERSECTS=961, MBROVERLAPS=962, 
		MBRTOUCHES=963, MBRWITHIN=964, MD5=965, MLINEFROMTEXT=966, MLINEFROMWKB=967, 
		MONTHNAME=968, MPOINTFROMTEXT=969, MPOINTFROMWKB=970, MPOLYFROMTEXT=971, 
		MPOLYFROMWKB=972, MULTILINESTRINGFROMTEXT=973, MULTILINESTRINGFROMWKB=974, 
		MULTIPOINTFROMTEXT=975, MULTIPOINTFROMWKB=976, MULTIPOLYGONFROMTEXT=977, 
		MULTIPOLYGONFROMWKB=978, NAME_CONST=979, NULLIF=980, NUMGEOMETRIES=981, 
		NUMINTERIORRINGS=982, NUMPOINTS=983, OCT=984, OCTET_LENGTH=985, ORD=986, 
		OVERLAPS=987, PERIOD_ADD=988, PERIOD_DIFF=989, PI=990, POINTFROMTEXT=991, 
		POINTFROMWKB=992, POINTN=993, POLYFROMTEXT=994, POLYFROMWKB=995, POLYGONFROMTEXT=996, 
		POLYGONFROMWKB=997, POW=998, POWER=999, QUOTE=1000, RADIANS=1001, RAND=1002, 
		RANDOM_BYTES=1003, RELEASE_LOCK=1004, REVERSE=1005, ROUND=1006, ROW_COUNT=1007, 
		RPAD=1008, RTRIM=1009, SEC_TO_TIME=1010, SECONDARY_ENGINE_ATTRIBUTE=1011, 
		SESSION_USER=1012, SHA=1013, SHA1=1014, SHA2=1015, SCHEMA_NAME=1016, SIGN=1017, 
		SIN=1018, SLEEP=1019, SOUNDEX=1020, SQL_THREAD_WAIT_AFTER_GTIDS=1021, 
		SQRT=1022, SRID=1023, STARTPOINT=1024, STRCMP=1025, STR_TO_DATE=1026, 
		ST_AREA=1027, ST_ASBINARY=1028, ST_ASTEXT=1029, ST_ASWKB=1030, ST_ASWKT=1031, 
		ST_BUFFER=1032, ST_CENTROID=1033, ST_CONTAINS=1034, ST_CROSSES=1035, ST_DIFFERENCE=1036, 
		ST_DIMENSION=1037, ST_DISJOINT=1038, ST_DISTANCE=1039, ST_ENDPOINT=1040, 
		ST_ENVELOPE=1041, ST_EQUALS=1042, ST_EXTERIORRING=1043, ST_GEOMCOLLFROMTEXT=1044, 
		ST_GEOMCOLLFROMTXT=1045, ST_GEOMCOLLFROMWKB=1046, ST_GEOMETRYCOLLECTIONFROMTEXT=1047, 
		ST_GEOMETRYCOLLECTIONFROMWKB=1048, ST_GEOMETRYFROMTEXT=1049, ST_GEOMETRYFROMWKB=1050, 
		ST_GEOMETRYN=1051, ST_GEOMETRYTYPE=1052, ST_GEOMFROMTEXT=1053, ST_GEOMFROMWKB=1054, 
		ST_INTERIORRINGN=1055, ST_INTERSECTION=1056, ST_INTERSECTS=1057, ST_ISCLOSED=1058, 
		ST_ISEMPTY=1059, ST_ISSIMPLE=1060, ST_LINEFROMTEXT=1061, ST_LINEFROMWKB=1062, 
		ST_LINESTRINGFROMTEXT=1063, ST_LINESTRINGFROMWKB=1064, ST_NUMGEOMETRIES=1065, 
		ST_NUMINTERIORRING=1066, ST_NUMINTERIORRINGS=1067, ST_NUMPOINTS=1068, 
		ST_OVERLAPS=1069, ST_POINTFROMTEXT=1070, ST_POINTFROMWKB=1071, ST_POINTN=1072, 
		ST_POLYFROMTEXT=1073, ST_POLYFROMWKB=1074, ST_POLYGONFROMTEXT=1075, ST_POLYGONFROMWKB=1076, 
		ST_SRID=1077, ST_STARTPOINT=1078, ST_SYMDIFFERENCE=1079, ST_TOUCHES=1080, 
		ST_UNION=1081, ST_WITHIN=1082, ST_X=1083, ST_Y=1084, SUBDATE=1085, SUBSTRING_INDEX=1086, 
		SUBTIME=1087, SYSTEM_USER=1088, TAN=1089, TIMEDIFF=1090, TIMESTAMPADD=1091, 
		TIMESTAMPDIFF=1092, TIME_FORMAT=1093, TIME_TO_SEC=1094, TOUCHES=1095, 
		TO_BASE64=1096, TO_DAYS=1097, TO_SECONDS=1098, UCASE=1099, UNCOMPRESS=1100, 
		UNCOMPRESSED_LENGTH=1101, UNHEX=1102, UNIX_TIMESTAMP=1103, UPDATEXML=1104, 
		UPPER=1105, UUID=1106, UUID_SHORT=1107, VALIDATE_PASSWORD_STRENGTH=1108, 
		VERSION=1109, WAIT_UNTIL_SQL_THREAD_AFTER_GTIDS=1110, WEEKDAY=1111, WEEKOFYEAR=1112, 
		WEIGHT_STRING=1113, WITHIN=1114, YEARWEEK=1115, Y_FUNCTION=1116, X_FUNCTION=1117, 
		VIA=1118, LASTVAL=1119, NEXTVAL=1120, SETVAL=1121, PREVIOUS=1122, PERSISTENT=1123, 
		BINLOG_MONITOR=1124, BINLOG_REPLAY=1125, FEDERATED_ADMIN=1126, READ_ONLY_ADMIN=1127, 
		REPLICA=1128, REPLICAS=1129, REPLICATION_MASTER_ADMIN=1130, MONITOR=1131, 
		READ_ONLY=1132, REPLAY=1133, VAR_ASSIGN=1134, PLUS_ASSIGN=1135, MINUS_ASSIGN=1136, 
		MULT_ASSIGN=1137, DIV_ASSIGN=1138, MOD_ASSIGN=1139, AND_ASSIGN=1140, XOR_ASSIGN=1141, 
		OR_ASSIGN=1142, STAR=1143, DIVIDE=1144, MODULE=1145, PLUS=1146, MINUS=1147, 
		DIV=1148, MOD=1149, EQUAL_SYMBOL=1150, GREATER_SYMBOL=1151, LESS_SYMBOL=1152, 
		EXCLAMATION_SYMBOL=1153, BIT_NOT_OP=1154, BIT_OR_OP=1155, BIT_AND_OP=1156, 
		BIT_XOR_OP=1157, DOT=1158, LR_BRACKET=1159, RR_BRACKET=1160, COMMA=1161, 
		SEMI=1162, AT_SIGN=1163, ZERO_DECIMAL=1164, ONE_DECIMAL=1165, TWO_DECIMAL=1166, 
		SINGLE_QUOTE_SYMB=1167, DOUBLE_QUOTE_SYMB=1168, REVERSE_QUOTE_SYMB=1169, 
		COLON_SYMB=1170, CHARSET_REVERSE_QOUTE_STRING=1171, FILESIZE_LITERAL=1172, 
		START_NATIONAL_STRING_LITERAL=1173, STRING_LITERAL=1174, DECIMAL_LITERAL=1175, 
		HEXADECIMAL_LITERAL=1176, REAL_LITERAL=1177, NULL_SPEC_LITERAL=1178, BIT_STRING=1179, 
		STRING_CHARSET_NAME=1180, DOT_ID=1181, ID=1182, REVERSE_QUOTE_ID=1183, 
		HOST_IP_ADDRESS=1184, LOCAL_ID=1185, GLOBAL_ID=1186, ERROR_RECONGNIGION=1187;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'STARTING'", "'STATEMENT'", "'STRAIGHT_JOIN'", "'SYSTEM'", "'SYSTEM_TIME'", 
