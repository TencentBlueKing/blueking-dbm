...
type TbSimulationImgCfg struct {
	...
	ComponentType string    `gorm:"uniqueIndex:idx_component_version;column:component_type;type:varchar(64);not null" json:"component_type"`
	Version       string    `gorm:"uniqueIndex:idx_component_version;column:version;type:varchar(64);not null" json:"version"`
