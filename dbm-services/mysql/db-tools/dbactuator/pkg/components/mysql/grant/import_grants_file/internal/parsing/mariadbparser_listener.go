...
type MariaDBParserListener interface {
	...
	// EnterTableOptionWithSystemVersioning is called when entering the tableOptionWithSystemVersioning production.
	EnterTableOptionWithSystemVersioning(c *TableOptionWithSystemVersioningContext)
	...
	// EnterPartitionSystemVersion is called when entering the partitionSystemVersion production.
	EnterPartitionSystemVersion(c *PartitionSystemVersionContext)

	// EnterPartitionSystemVersionDefinitions is called when entering the partitionSystemVersionDefinitions production.
	EnterPartitionSystemVersionDefinitions(c *PartitionSystemVersionDefinitionsContext)

	// EnterPartitionSystemVersionDefinition is called when entering the partitionSystemVersionDefinition production.
	EnterPartitionSystemVersionDefinition(c *PartitionSystemVersionDefinitionContext)
	...
	// EnterAlterByAlterIndexIgnore is called when entering the alterByAlterIndexIgnore production.
	EnterAlterByAlterIndexIgnore(c *AlterByAlterIndexIgnoreContext)
	...
	// EnterUuidDataType is called when entering the uuidDataType production.
	EnterUuidDataType(c *UuidDataTypeContext)
	...
	// ExitTableOptionWithSystemVersioning is called when exiting the tableOptionWithSystemVersioning production.
	ExitTableOptionWithSystemVersioning(c *TableOptionWithSystemVersioningContext)
	...
	// ExitPartitionSystemVersion is called when exiting the partitionSystemVersion production.
	ExitPartitionSystemVersion(c *PartitionSystemVersionContext)

	// ExitPartitionSystemVersionDefinitions is called when exiting the partitionSystemVersionDefinitions production.
	ExitPartitionSystemVersionDefinitions(c *PartitionSystemVersionDefinitionsContext)

	// ExitPartitionSystemVersionDefinition is called when exiting the partitionSystemVersionDefinition production.
	ExitPartitionSystemVersionDefinition(c *PartitionSystemVersionDefinitionContext)
	...
	// ExitAlterByAlterIndexIgnore is called when exiting the alterByAlterIndexIgnore production.
	ExitAlterByAlterIndexIgnore(c *AlterByAlterIndexIgnoreContext)
	...
	// ExitUuidDataType is called when exiting the uuidDataType production.
	ExitUuidDataType(c *UuidDataTypeContext)
