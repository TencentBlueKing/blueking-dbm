...
INSERT INTO `tb_config_file_def` (`id`, `namespace`, `conf_type`, `conf_file`, `conf_type_lc`, `conf_file_lc`, `level_names`, `level_versioned`, `conf_name_validate`, `conf_value_validate`, `value_type_strict`, `namespace_info`, `version_keep_limit`, `version_keep_days`, `conf_name_order`, `description`, `created_at`, `updated_at`, `updated_by`) VALUES (267,'mongodb','mongos','defaultconf','mongos配置','defaultconf','plat,app,cluster','cluster',1,1,1,'mongos',5,365,0,'mongos默认配置','2023-10-23 15:47:13','2023-11-03 10:45:22',NULL);
INSERT INTO `tb_config_file_def` (`id`, `namespace`, `conf_type`, `conf_file`, `conf_type_lc`, `conf_file_lc`, `level_names`, `level_versioned`, `conf_name_validate`, `conf_value_validate`, `value_type_strict`, `namespace_info`, `version_keep_limit`, `version_keep_days`, `conf_name_order`, `description`, `created_at`, `updated_at`, `updated_by`) VALUES (268,'mongodb','osconf','defaultconf','os配置','osconf','plat,app,cluster','',1,1,1,'mongodbcommon',5,365,0,'os默认配置','2023-10-23 15:49:01','2023-11-13 17:41:19',NULL);
...
INSERT INTO `tb_config_name_def` (`id`, `namespace`, `conf_type`, `conf_file`, `conf_name`, `value_type`, `value_default`, `value_allowed`, `value_type_sub`, `flag_status`, `flag_disable`, `flag_locked`, `flag_encrypt`, `need_restart`, `value_formula`, `extra_info`, `conf_name_lc`, `order_index`, `since_version`, `description`, `created_at`, `updated_at`, `stage`) VALUES (18174,'mongodb','osconf','defaultconf','backup_dir','STRING','','','ENUM',1,0,0,0,1,NULL,NULL,NULL,-1,NULL,NULL,'2023-10-20 19:30:09','2023-11-09 15:36:48',0);
INSERT INTO `tb_config_name_def` (`id`, `namespace`, `conf_type`, `conf_file`, `conf_name`, `value_type`, `value_default`, `value_allowed`, `value_type_sub`, `flag_status`, `flag_disable`, `flag_locked`, `flag_encrypt`, `need_restart`, `value_formula`, `extra_info`, `conf_name_lc`, `order_index`, `since_version`, `description`, `created_at`, `updated_at`, `stage`) VALUES (18216,'mongodb','osconf','defaultconf','file_path','/data','/data',NULL,'ENUM',1,0,0,0,1,NULL,NULL,NULL,-1,NULL,NULL,'2023-11-09 16:37:54','2023-11-09 16:37:54',0);
...
INSERT INTO `tb_config_name_def` (`id`, `namespace`, `conf_type`, `conf_file`, `conf_name`, `value_type`, `value_default`, `value_allowed`, `value_type_sub`, `flag_status`, `flag_disable`, `flag_locked`, `flag_encrypt`, `need_restart`, `value_formula`, `extra_info`, `conf_name_lc`, `order_index`, `since_version`, `description`, `created_at`, `updated_at`, `stage`) VALUES (18173,'mongodb','osconf','defaultconf','install_dir','STRING','','','ENUM',1,0,0,0,1,NULL,NULL,NULL,-1,NULL,NULL,'2023-10-20 19:29:39','2023-11-09 15:36:48',0);
