...
{{- define "milvus.datacoord.cmpdName" -}}
datacoord-{{ .Chart.Version }}
{{- end -}}

{{- define "milvus.indexnode.cmpdName" -}}
indexnode-{{ .Chart.Version }}
{{- end -}}

{{- define "milvus.indexcoord.cmpdName" -}}
indexcoord-{{ .Chart.Version }}
{{- end -}}
...
{{- define "milvus.querycoord.cmpdName" -}}
querycoord-{{ .Chart.Version }}
{{- end -}}

{{- define "milvus.rootcoord.cmpdName" -}}
rootcoord-{{ .Chart.Version }}
{{- end -}}
