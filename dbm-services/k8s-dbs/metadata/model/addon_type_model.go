...
// AddonTypeModel represents the database model of addon type
type AddonTypeModel struct {
	ID          uint64                 `gorm:"primaryKey;autoIncrement;column:id" json:"id"`
	CategoryID  uint64                 `gorm:"column:category_id" json:"categoryId"`
	TypeName    string                 `gorm:"size:32;not null;column:type_name" json:"typeName"`
	TypeAlias   string                 `gorm:"size:32;not null;column:type_alias" json:"typeAlias"`
