...
// AddonCategoryModel represents the database model of addon category
type AddonCategoryModel struct {
	ID            uint64                 `gorm:"primaryKey;autoIncrement;column:id" json:"id"`
	CategoryName  string                 `gorm:"size:32;not null;column:category_name" json:"categoryName"`
	CategoryAlias string                 `gorm:"size:32;not null;column:category_alias" json:"categoryAlias"`
...
func (AddonCategoryModel) TableName() string {
	return constant.TbAddonCategory
}
