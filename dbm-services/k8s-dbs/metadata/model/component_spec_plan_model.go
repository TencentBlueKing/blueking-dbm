...
// ComponentSpecPlanModel 存储套餐组件配置表 model定义
type ComponentSpecPlanModel struct {
	ID              uint64                 `gorm:"primaryKey;autoIncrement;column:id" json:"id"`
	AddonSpecPlanID uint64                 `gorm:"not null;column:addon_spec_plan_id" json:"addonSpecPlanId"`
	...
	MemoryGb        *int                   `gorm:"column:memory_gb" json:"memoryGb"`
	DiskSizeGb      *int                   `gorm:"column:disk_size_gb" json:"diskSizeGb"`
...
func (ComponentSpecPlanModel) TableName() string {
	return constant.TbComponentSpecPlan
}
