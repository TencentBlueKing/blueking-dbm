...
// AddonSpecPlanModel 存储套餐配置表 model定义
type AddonSpecPlanModel struct {
	ID             uint64                 `gorm:"primaryKey;autoIncrement;column:id" json:"id"`
	AddonID        uint64                 `gorm:"not null;column:addon_id" json:"addonId"`
	AddonTopology  string                 `gorm:"size:32;not null;default:'';column:addon_topology" json:"addonTopology"`
	SpecLevel      string                 `gorm:"size:32;not null;default:'basic';column:spec_level" json:"specLevel"`
	SpecLevelAlias string                 `gorm:"size:32;not null;default:'';column:spec_level_alias" json:"specLevelAlias"` //nolint:lll
...
func (AddonSpecPlanModel) TableName() string {
	return constant.TbAddonSpecPlan
}
