...
// AddonClusterVersionModel represents the database model of addon cluster version
type AddonClusterVersionModel struct {
	ID               uint64                 `gorm:"primaryKey;autoIncrement;column:id" json:"id"`
	AddonID          uint64                 `gorm:"not null;column:addon_id" json:"addonId"`
	Version          string                 `gorm:"size:32;column:version" json:"version"`
	AddonClusterName string                 `gorm:"size:32;column:addoncluster_name" json:"addonClusterName"`
...
func (AddonClusterVersionModel) TableName() string {
	return constant.TbAddonClusterVersion
}
