...
var addonClusterReleaseSample = &models.AddonClusterReleaseModel{
	...
	RepoRepository:     "https://charts.release.example.com",
	ChartVersion:       "1.0.0",
...
var batchAddonClusterReleaseSamples = []*models.AddonClusterReleaseModel{
	{
		...
		RepoRepository:     "https://charts.redis-release.com",
		ChartVersion:       "2.0.0",
	...
	},
	{
		...
		RepoRepository:     "https://charts.mongodb-release.com",
		ChartVersion:       "3.0.0",
...
func (suite *AddonClusterReleaseDbAccessTestSuite) TestUpdateAddonClusterRelease() {
	...
	newRelease := &models.AddonClusterReleaseModel{
		...
		RepoRepository:     "https://charts.updated-release.com",
		ChartVersion:       "1.1.0",
