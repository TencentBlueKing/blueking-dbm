...
type K8sCrdCmpvDbAccess interface {
	...
	ListByPage(pagination entity.Pagination) ([]models.K8sCrdComponentVersionModel, int64, error)
}
...
func (k *K8sCrdComponentVersionDbAccessImpl) ListByPage(_ entity.Pagination) (
