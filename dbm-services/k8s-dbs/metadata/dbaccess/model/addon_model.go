...
type K8sCrdStorageAddonModel struct {
	...
	RecommendedAcVersion string    `gorm:"size:32;not null;column:recommended_addoncluster_version" json:"recommended_addoncluster_version"` //nolint:lll
	SupportedAcVersions  string    `gorm:"size:1000;not null;column:supported_addoncluster_versions" json:"supported_addoncluster_versions"` //nolint:lll
