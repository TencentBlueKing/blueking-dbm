...
type OperationDefinitionModel struct {
	...
	OperationName   string    `gorm:"size:32;not null;column:operation_name" json:"operation_name"`
	OperationTarget string    `gorm:"size:32;not null;column:operation_target" json:"operation_target"`
