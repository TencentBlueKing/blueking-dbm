...
// ComponentOperationModel represents the database model of component definition
type ComponentOperationModel struct {
	...
	ComponentName    string    `gorm:"size:32;not null;column:component_name" json:"component_name"`
	ComponentVersion string    `gorm:"size:32;not null;column:component_version" json:"component_version"`
...
func (ComponentOperationModel) TableName() string {
	return constant.TbComponentOperation
}
