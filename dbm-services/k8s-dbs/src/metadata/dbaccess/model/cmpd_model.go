...
type K8sCrdComponentDefinitionModel struct {
	...
	ComponentDefinitionName string    `gorm:"size:100;not null;column:componentdefinition_name" json:"componentdefinition_name"`
...
func (K8sCrdComponentDefinitionModel) TableName() string {
	return constant.TB_K8S_CRD_COMPONENTDEFINITION
}
