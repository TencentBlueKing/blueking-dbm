...
import (
	"dbm-services/mongo/db-tools/dbmon/pkg/linuxproc"
	"fmt"
	"slices"
	"strings"
	"time"
	...
	"dbm-services/mongo/db-tools/dbmon/embedfiles"
...
/*
	    ...
	    my $cmd        = "/usr/local/mongodb/bin/mongo --quiet --eval \"{var user='$user';var pwd='$pass';}\"

$host:$port/admin $RealBin/tools/login.js";
