...
func (d *DelUser) Init(runtime *jobruntime.JobGenericRuntime) error {
	...
	if d.ConfParams.InstanceType == "mongos" {
		...
		info, err := common.AuthGetPrimaryInfo(d.OsUser, d.Mongo, d.ConfParams.AdminUsername, d.ConfParams.AdminPassword,
...
func (d *DelUser) execScript() error {
	// 检查
	flag, err := common.AuthCheckUser(d.OsUser, d.Mongo, d.ConfParams.AdminUsername, d.ConfParams.AdminPassword,
	...
	cmd := fmt.Sprintf(
		...
		d.OsUser, d.Mongo, d.ConfParams.AdminUsername, d.ConfParams.AdminPassword, d.PrimaryIP,
