...
func (i *InitiateReplicaset) Init(runtime *jobruntime.JobGenericRuntime) error {
	...
	i.ClusterId = strings.Join([]string{i.ConfParams.App, i.ConfParams.AreaId, i.ConfParams.SetId}, "-")
...
func (i *InitiateReplicaset) getPrimaryInfo() (bool, error) {
	...
	result, err := common.InitiateReplicasetGetPrimaryInfo(i.OsUser, i.Mongo, i.ConfParams.IP, i.ConfParams.Port)
	if err != nil {
...
func (i *InitiateReplicaset) checkStatus() {
	for {
		result, err := common.NoAuthGetPrimaryInfo(i.OsUser, i.Mongo, i.ConfParams.IP, i.ConfParams.Port)
		if err != nil {
...
func (i *InitiateReplicaset) execScript() error {
	...
	cmd := fmt.Sprintf("su %s -c \"%s --host %s --port %d --quiet %s\"",
		i.OsUser, i.Mongo, "127.0.0.1", i.ConfParams.Port, i.ConfFilePath)
