...
func main() {
	...
	err = redistest.KeysFilesDelete(localIP, consts.TestPredixyPort,
	...
	err = redistest.KeysFilesDelete(localIP, consts.TestTwemproxyPort, repoUser, repoPassword, repoUrl,
		dbtoolsPkgName, dbtoolsPkgMd5)
	if err != nil {
		return
	}
